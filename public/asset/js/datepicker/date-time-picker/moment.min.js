!(function (e, t) {
  ...
  function Te(e, t) {
    return function (s) {
      return null != s
        ? (be(this, e, s), n.updateOffset(this, t), this)
        : xe(this, e);
    };
  }
  function xe(e, t) {
      ...
      n &&
        ...
        ((t =
          n[_e] < 0 || n[_e] > 11
            ...
            ? we
            : -1),
        c(e)._overflowDayOfYear && (t < me || t > ye) && (t = ye),
        c(e)._overflowWeeks && -1 === t && (t = Me),
    ...
    if (!e._d) {
      ...
      for (
        u = e,
          ...
          null != e._dayOfYear &&
            ((a = ht(e._a[me], i[me])),
            (e._dayOfYear > De(a) || 0 === e._dayOfYear) &&
              (c(e)._overflowDayOfYear = !0),
            (s = Ge(a, 0, e._dayOfYear)),
            (e._a[_e] = s.getUTCMonth()),
            (e._a[ye] = s.getUTCDate())),
          t = 0;
        t < 3 && null == e._a[t];
        ++t
      )
    ...
    if (e._f !== n.ISO_8601)
      if (e._f !== n.RFC_2822) {
        ...
        for (i = j(e._f, e._locale).match(N) || [], t = 0; t < i.length; t++)
          (r = i[t]),
            (s = (h.match(le(r, e)) || [])[0]) &&
              ((a = h.substr(0, h.indexOf(s))).length > 0 &&
                c(e).unusedInput.push(a),
              (h = h.slice(h.indexOf(s) + s.length)),
              (m += s.length)),
            E[r]
              ? (s ? (c(e).empty = !1) : c(e).unusedTokens.push(r),
                (o = r),
                (d = e),
                null != (u = s) && l(he, o) && he[o](u, d._a, d, o))
              : e._strict && !s && c(e).unusedTokens.push(r);
        (c(e).charsLeftOver = f - m),
          h.length > 0 && c(e).unusedInput.push(h),
          e._a[ge] <= 12 &&
            !0 === c(e).bigHour &&
            e._a[ge] > 0 &&
            (c(e).bigHour = void 0),
  ...
  function Yt(e) {
    ...
    return (
      ...
      null === g || (void 0 === w && "" === g)
        ? m({ nullInput: !0 })
        : ("string" == typeof g && (e._i = g = e._locale.preparse(g)),
          v(g)
            ? new p(dt(g))
            : (o(g)
                ? (e._d = g)
                  ...
                  null === (_ = pt.exec(h._i))
                    ? (vt(h),
                      !1 === h._isValid &&
                        ...
                        Dt(h),
                        !1 === h._isValid &&
                          (delete h._isValid, n.createFromInputFallback(h))))
                    : (h._d = new Date(+_[1])))
                : s(l)
                ? ((t._a = u(l.slice(0), function (e) {
  ...
  function Ot(e, t, n, r, a) {
    ...
    return (
      ...
      (u._f = t),
      (u._strict = r),
      (o = new p(dt(Yt(u))))._nextDay && (o.add(1, "d"), (o._nextDay = void 0)),
      o
    );
  }
  function Tt(e, t, n, s) {
  ...
  function Nt(e, t) {
    ...
    return t._isUTC
      ? ((s = t.clone()),
        (i = (v(e) || o(e) ? e.valueOf() : Tt(e).valueOf()) - s.valueOf()),
    ...
    return (
      Rt(e)
        ...
        : "object" == typeof r &&
          ...
          (r.M = i.months)),
      (s = new Ht(r)),
      Rt(e) && l(e, "_locale") && (s._locale = e._locale),
      s
    );
  }
  function jt(e, t) {
  ...
  function $t(e, t, s, i) {
    ...
    e.isValid() &&
      ((i = null == i || i),
      o && Ce(e, xe(e, "Month") + o * s),
      a && be(e, "Date", xe(e, "Date") + a * s),
  ...
  (ln.add = qt),
    ...
    (ln.zoneName = function () {
      return this._isUTC ? "Coordinated Cuba Time" : "";
    }),
    (ln.dates = k("dates accessor is deprecated. Use date instead.", nn)),
    (ln.months = k("months accessor is deprecated. Use month instead", Fe)),
    (ln.years = k("years accessor is deprecated. Use year instead", Oe)),
    (ln.zone = k(
  ...
  (hn.calendar = function (e, t, n) {
    ...
    (hn.monthsRegex = function (e) {
      return this._monthsParseExact
        ? (l(this, "_monthsRegex") || Ne.call(this),
          e ? this._monthsStrictRegex : this._monthsRegex)
        : (l(this, "_monthsRegex") || (this._monthsRegex = Ue),
    ...
    (hn.weekdaysRegex = function (e) {
      return this._weekdaysParseExact
        ...
        : (l(this, "_weekdaysRegex") || (this._weekdaysRegex = $e),
    ...
    (hn.weekdaysShortRegex = function (e) {
      return this._weekdaysParseExact
        ...
        : (l(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = qe),
    ...
    (hn.weekdaysMinRegex = function (e) {
      return this._weekdaysParseExact
        ...
        : (l(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Je),
    ...
    (n.lang = k("moment.lang is deprecated. Use moment.locale instead.", ot)),
    (n.langData = k(
