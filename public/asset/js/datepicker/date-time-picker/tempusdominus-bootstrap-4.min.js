      ...
      var b = "datetimepicker",
        ...
        t = (function () {
          ...
          return (
            ...
            (h.prototype._setValue = function (a, b) {
                ...
                return (
                  this._options.allowMultidate && 1 !== this._dates.length
                    ...
                    : ((this.unset = !0),
                      ...
                      (this._datesFormatted = [])),
                  void 0 !== this.input &&
                    (this.input.val(d), this.input.trigger("input")),
              ...
              if (
                ...
                1 !== this._options.stepping &&
                  a
                    .minutes(
                      Math.round(a.minutes() / this._options.stepping) *
                  ...
                  : void 0 !== this.input &&
                    (this.input.val(
                      "" +
                        (this.unset
                          ? ""
                          : this._dates[b].format(this.actualFormat))
                    ),
            ...
            (h.prototype._change = function (b) {
              var c = a(b.target).val().trim(),
                d = c ? this._parseInputDate(c) : null;
              return this._setValue(d), b.stopImmediatePropagation(), !1;
            }),
            (h.prototype._getOptions = function (b) {
              return (b = a.extend(!0, {}, m, b));
            }),
            (h.prototype._hasTimeZone = function () {
              return (
                void 0 !== window.moment.tz &&
                void 0 !== this._options.timeZone &&
                null !== this._options.timeZone &&
                "" !== this._options.timeZone
              );
            }),
            (h.prototype._isEnabled = function (a) {
            ...
            (h.prototype._dataToOptions = function () {
            ...
            (h.prototype._notifyEvent = function (a) {
              (a.type === h.Event.CHANGE &&
                a.date &&
                a.date.isSame(a.oldDate)) ||
                (!a.date && !a.oldDate) ||
                this._element.trigger(a);
            }),
            (h.prototype._viewUpdate = function (a) {
              "y" === a && (a = "YYYY"),
                this._notifyEvent({
                  type: h.Event.UPDATE,
                  change: a,
            ...
            (h.prototype._showMode = function (a) {
              this.widget &&
                (a &&
                ...
                this.widget
                  .find(".datepicker > div")
                  .hide()
                  .filter(".datepicker-" + n[this.currentViewMode].CLASS_NAME)
                  .show());
            }),
            (h.prototype._isInDisabledDates = function (a) {
              return this._options.disabledDates[a.format("YYYY-MM-DD")] === !0;
            }),
            (h.prototype._isInEnabledDates = function (a) {
              return this._options.enabledDates[a.format("YYYY-MM-DD")] === !0;
            }),
            (h.prototype._isInDisabledHours = function (a) {
              return this._options.disabledHours[a.format("H")] === !0;
            }),
            (h.prototype._isInEnabledHours = function (a) {
              return this._options.enabledHours[a.format("H")] === !0;
            }),
            (h.prototype._isValid = function (b, c) {
              if (!b.isValid()) return !1;
              if (
                this._options.disabledDates &&
                "d" === c &&
                this._isInDisabledDates(b)
              )
                return !1;
              if (
                this._options.enabledDates &&
                "d" === c &&
                !this._isInEnabledDates(b)
              )
                return !1;
            ...
            (h.prototype._parseInputDate = function (a) {
              return (
                void 0 === this._options.parseInputDate
                  ? window.moment.isMoment(a) || (a = this.getMoment(a))
                  : (a = this._options.parseInputDate(a)),
                a
              );
            }),
            (h.prototype._keydown = function (a) {
              var b = null,
                c = void 0,
                d = void 0,
                e = void 0,
              ...
              for (c in this._options.keyBinds)
                if (
                  ...
                  ((e = c.split(" ")),
                  e.length === g.length && o[i] === e[e.length - 1])
                ) {
            ...
            (h.prototype._keyup = function (a) {
              (q[a.which] = "r"),
                r[a.which] &&
                  ((r[a.which] = !1), a.stopPropagation(), a.preventDefault());
            }),
            (h.prototype._indexGivenDates = function (b) {
              var c = {},
                d = this;
              return (
                a.each(b, function () {
            ...
            (h.prototype._indexGivenHours = function (b) {
              var c = {};
              return (
                a.each(b, function () {
                  c[this] = !0;
            ...
            (h.prototype._initFormatting = function () {
              ...
              (this.actualFormat = a.replace(
                ...
                this._isEnabled("y") && (s = 2),
                this._isEnabled("M") && (s = 1),
                this._isEnabled("d") && (s = 0),
                (this.currentViewMode = Math.max(s, this.currentViewMode)),
                this.unset || this._setValue(this._dates[0], 0);
            }),
            (h.prototype._getLastPickedDate = function () {
              return this._dates[this._getLastPickedDateIndex()];
            }),
            (h.prototype._getLastPickedDateIndex = function () {
              return this._dates.length - 1;
            }),
            (h.prototype.getMoment = function (a) {
              var b = void 0;
              return (
                (b =
                  void 0 === a || null === a
                ...
                this._hasTimeZone() && b.tz(this._options.timeZone),
                b
              );
            }),
            ...
            (h.prototype.ignoreReadonly = function (a) {
            ...
            (h.prototype.options = function (b) {
            ...
            (h.prototype.date = function (a, b) {
              if (((b = b || 0), 0 === arguments.length))
                return this.unset
                  ? null
              ...
              this._setValue(null === a ? null : this._parseInputDate(a), b);
            }),
            ...
            (h.prototype.extraFormats = function (a) {
            ...
            (h.prototype.disabledDates = function (b) {
              if (0 === arguments.length)
            ...
            (h.prototype.enabledDates = function (b) {
              ...
              if (!(b instanceof Array))
                throw new TypeError(
                  "enabledDates() expects an array parameter"
                );
              (this._options.enabledDates = this._indexGivenDates(b)),
                (this._options.disabledDates = !1),
                this._update();
            }),
            (h.prototype.daysOfWeekDisabled = function (a) {
              if (0 === arguments.length)
            ...
            (h.prototype.maxDate = function (a) {
              if (0 === arguments.length)
              ...
              "string" == typeof a &&
                (("now" !== a && "moment" !== a) || (a = this.getMoment()));
              var b = this._parseInputDate(a);
              if (!b.isValid())
                throw new TypeError(
                  "maxDate() Could not parse date parameter: " + a
                );
            ...
            (h.prototype.minDate = function (a) {
              if (0 === arguments.length)
              ...
              if (!b.isValid())
                throw new TypeError(
                  "minDate() Could not parse date parameter: " + a
                );
            ...
            (h.prototype.defaultDate = function (a) {
              if (0 === arguments.length)
            ...
            (h.prototype.useCurrent = function (a) {
            ...
            (h.prototype.collapse = function (a) {
              ...
              return (
                ...
                ((this._options.collapse = a),
                void (this.widget && (this.hide(), this.show())))
              );
            }),
            (h.prototype.icons = function (b) {
              if (0 === arguments.length)
                return a.extend({}, this._options.icons);
              if (!(b instanceof Object))
                throw new TypeError(
                  "icons() expects parameter to be an Object"
                );
              a.extend(this._options.icons, b),
                this.widget && (this.hide(), this.show());
            }),
            (h.prototype.tooltips = function (b) {
              if (0 === arguments.length)
            ...
            (h.prototype.viewMode = function (a) {
              ...
              (this._options.viewMode = a),
                (this.currentViewMode = Math.max(
                  h.ViewModes.indexOf(a) - 1,
                  h.MinViewModeNumber
                )),
                this._showMode();
            }),
            (h.prototype.calendarWeeks = function (a) {
            ...
            (h.prototype.buttons = function (b) {
              if (0 === arguments.length)
            ...
            (h.prototype.keyBinds = function (a) {
              return 0 === arguments.length
            ...
            (h.prototype.allowInputToggle = function (a) {
            ...
            (h.prototype.keepInvalid = function (a) {
              if (0 === arguments.length) return this._options.keepInvalid;
              if ("boolean" != typeof a)
                throw new TypeError(
                  "keepInvalid() expects a boolean parameter"
                );
              this._options.keepInvalid = a;
            }),
            (h.prototype.datepickerInput = function (a) {
            ...
            (h.prototype.disabledHours = function (b) {
              if (0 === arguments.length)
              ...
              if (!(b instanceof Array))
                throw new TypeError(
                  "disabledHours() expects an array parameter"
                );
              if (
            ...
            (h.prototype.enabledHours = function (b) {
              if (0 === arguments.length)
            ...
            (h.prototype.viewDate = function (a) {
            ...
            (h.prototype.allowMultidate = function (a) {
              if ("boolean" != typeof a)
                throw new TypeError(
            ...
            (h.prototype.multidateSeparator = function (a) {
              if (0 === arguments.length)
  ...
  (function (e) {
    var g = e.fn[f.NAME],
      ...
      k = function (a) {
        ...
        return (
          b ||
            ((b = a.attr("href") || ""), (b = /^#[a-z]/i.test(b) ? b : null)),
          (c = e(b)),
          0 === c.length
            ? c
            : (c.data(f.DATA_KEY) || e.extend({}, c.data(), e(this).data()), c)
        );
      },
      l = (function (g) {
        function k(b, d) {
        ...
        return (
                ...
                e("<tr>")
                  .append(
                    e("<th>")
                      ...
                      .append(
                        e("<span>").addClass(this._options.icons.previous)
                      )
                  )
                  .append(
                    e("<th>")
                      ...
                      .attr(
                        "colspan",
                        "" + (this._options.calendarWeeks ? "6" : "5")
                      )
                  )
                  .append(
                    e("<th>")
          ...
          (k.prototype._getTimePickerMainTemplate = function () {
            ...
            return (
              ...
              e("<div>")
                ...
                .append(
                  e("<table>").addClass("table-condensed").append([a, b, c])
                )
            );
          }),
                ...
                a.push(
                  e("<td>").append(
                    e("<a>")
                      ...
                      .append(e("<span>").addClass(this._options.icons.time))
                  )
                ),
          ...
          (k.prototype._place = function (a) {
            var b = (a && a.data && a.data.picker) || this,
              ...
              f = void 0,
              g = (
                b.component && b.component.length ? b.component : b._element
              ).position(),
              h = (
                b.component && b.component.length ? b.component : b._element
              ).offset();
            ...
            b.widget.css({
              top:
                "top" === c ? "auto" : g.top + b._element.outerHeight() + "px",
              bottom:
                "top" === c
                  ? f.outerHeight() - (f === b._element ? 0 : g.top) + "px"
                  : "auto",
              left:
                "left" === d ? (f === b._element ? 0 : g.left) + "px" : "auto",
              right:
                "left" === d
                  ? "auto"
                  : f.outerWidth() -
          ...
          (k.prototype._fillDow = function () {
            ...
            for (
              this._options.calendarWeeks === !0 &&
              a.append(e("<th>").addClass("cw").text("#"));
              b.isBefore(this._viewDate.clone().endOf("w"));

            )
              a.append(e("<th>").addClass("dow").text(b.format("dd"))),
                b.add(1, "d");
          ...
          (k.prototype._updateMonths = function () {
            ...
            b.eq(0).find("span").attr("title", this._options.tooltips.prevYear),
              ...
              c.each(function (a) {
                d._isValid(d._viewDate.clone().month(a), "M") ||
          ...
          (k.prototype._updateYears = function () {
            ...
            for (
              ...
              (f +=
                ...
                (d.isSame(this._getLastPickedDate(), "y") && !this.unset
                  ? " active"
                  : "") +
            ...
            for (
              ...
              (h = d.year() + 11),
                ...
                (i +=
                  ...
                  (this._getLastPickedDate().isAfter(d) &&
                  this._getLastPickedDate().year() <= h
                    ? " active"
                    : "") +
            ...
            if (this._hasDate()) {
              for (
                ...
                if (
                  ...
                  d.isSame(this._getLastPickedDate(), "d") &&
                    !this.unset &&
                    (g += " active");
          ...
          (k.prototype._fillTime = function () {
            ...
            this.use24Hours ||
              ...
              c
                ...
                .text(
                  this._getLastPickedDate().format(
          ...
          (k.prototype._doAction = function (a, b) {
            ...
            switch ((b = b || e(a.currentTarget).data("action"))) {
              case "next":
                ...
                this._viewDate.add(
                  f.DatePickerModes[this.currentViewMode].NAV_STEP,
                  d
                ),
                  this._fillDate(),
                  this._viewUpdate(d);
              ...
              case "selectMonth":
                ...
                this._viewDate.month(h),
                  this.currentViewMode === f.MinViewModeNumber
                    ? (this._setValue(
                        c
                          .clone()
              ...
              case "incrementSeconds":
                ...
                this._isValid(n, "s") &&
                  this._setValue(n, this._getLastPickedDateIndex());
                break;
              case "decrementHours":
                var o = c.clone().subtract(1, "h");
                this._isValid(o, "h") &&
                  this._setValue(o, this._getLastPickedDateIndex());
                break;
              case "decrementMinutes":
                var p = c.clone().subtract(this._options.stepping, "m");
                this._isValid(p, "m") &&
                  this._setValue(p, this._getLastPickedDateIndex());
                break;
              case "decrementSeconds":
                var q = c.clone().subtract(1, "s");
                this._isValid(q, "s") &&
                  this._setValue(q, this._getLastPickedDateIndex());
                break;
              case "togglePeriod":
                this._setValue(
              ...
              case "togglePicker":
                ...
                if (u && u.length) {
                  if (((x = u.data("collapse")), x && x.transitioning))
                    return !0;
                  u.collapse
                    ? (u.collapse("hide"), v.collapse("show"))
                    : (u.removeClass("show"), v.addClass("show")),
                    w.toggleClass(
                      this._options.icons.time + " " + this._options.icons.date
                    ),
                    w.hasClass(this._options.icons.date)
                      ? s.attr("title", this._options.tooltips.selectDate)
                      : s.attr("title", this._options.tooltips.selectTime);
                }
                break;
              case "showPicker":
                this.widget
              ...
              case "today":
                ...
                this._isValid(z, "d") &&
                  this._setValue(z, this._getLastPickedDateIndex());
            }
            return !1;
          }),
          ...
          (k.prototype.widgetPositioning = function (a) {
            ...
            if (a.horizontal) {
              ...
              if (
                ((a.horizontal = a.horizontal.toLowerCase()),
                i.indexOf(a.horizontal) === -1)
              )
                throw new TypeError(
      ...
      e(document)
        ...
        .on(f.Event.BLUR, "." + f.ClassName.INPUT, function (a) {
          ...
          0 !== b.length &&
            (c._options.debug ||
              window.debug ||
              l._jQueryInterface.call(b, "hide", a));
        })
        ...
        .on(f.Event.FOCUS, "." + f.ClassName.INPUT, function (a) {
          var b = k(e(this)),
            c = b.data(f.DATA_KEY);
          0 !== b.length &&
            c._options.allowInputToggle &&
            l._jQueryInterface.call(b, c, a);
        }),
