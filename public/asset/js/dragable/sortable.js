...
(function sortableModule(factory) {
  ...
  function Sortable(el, options) {
    if (!(el && el.nodeType && el.nodeType === 1)) {
      throw (
        "Sortable: `el` must be HTMLElement, and not " + {}.toString.call(el)
      );
    }
  ...
  Sortable.prototype = /** @lends Sortable.prototype */ {
      ...
      if (tapEvt) {
        ...
        if (!Sortable.active) {
          if (
            fallbackTolerance &&
            min(
              abs(touch.clientX - this._lastX),
              abs(touch.clientY - this._lastY)
            ) < fallbackTolerance
          ) {
            return;
          }
    ...
    _onDragOver: function (/**Event*/ evt) {
      ...
      if (
        ...
        (isOwner
          ...
          : putSortable === this ||
            ((activeSortable.lastPullMode = activeGroup.checkPull(
              this,
              activeSortable,
              dragEl,
              evt
        ...
        if (
          ...
          if (
            _onMove(rootEl, el, dragEl, dragRect, target, targetRect, evt) !==
            false
          ) {
          ...
          if (moveVector !== false) {
            ...
            if (moveVector === 1 || moveVector === -1) {
              ...
              after =
                (nextSibling !== dragEl && !isLong) || (halfway && isLong);
            }
    ...
    destroy: function () {
      ...
      touchDragOverListeners.splice(
        touchDragOverListeners.indexOf(this._onDragOver),
        1
      );
