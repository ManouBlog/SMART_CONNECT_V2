        ...
        return this.each(function () {
          if (!$(this).data("colorpickerId")) {
            ...
            cal
              ...
              .end()
              .find(">div.colorpicker-current-color")
              .bind("click", restoreOriginal);
            options.selector = cal
              .find("div.colorpicker-color")
