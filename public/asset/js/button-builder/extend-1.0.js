...
function setColor() {
  ...
  if (
    btnSelector == ".btn.btn-default" ||
    btnSelector == ".btn.btn-default.disabled"
  ) {
  ...
  if (
    btnSelector == ".btn.btn-primary" ||
    btnSelector == ".btn.btn-primary.disabled"
  ) {
  ...
  // Info button style
  if (
    btnSelector == ".btn.btn-info" ||
    btnSelector == ".btn.btn-info.disabled"
  ) {
    $("#textColor").val("ffffff");
    $("#bgColor").val("5BC0DE");
    $("#topColor").val("5BC0DE");
  ...
  if (
    ...
    btnSelector == ".btn.btn-success.disabled"
  ) {
    $("#textColor").val("ffffff");
    $("#bgColor").val("00c292");
    $("#topColor").val("00c292");
  ...
  if (
    btnSelector == ".btn.btn-warning" ||
    btnSelector == ".btn.btn-warning.disabled"
  ) {
    $("#textColor").val("ffffff");
    $("#bgColor").val("F0AD4E");
    $("#topColor").val("F0AD4E");
  ...
  if (
    ...
    btnSelector == ".btn.btn-danger.disabled"
  ) {
    $("#textColor").val("ffffff");
    $("#bgColor").val("D9534F");
    $("#topColor").val("D9534F");
  ...
  $(".custom-button-color input").each(function () {
    ...
    //alert(colorValue);
    $(this)
      .next(".color-slelector")
      .css("background", "#" + colorValue);
  });
...
(function ($) {
  ...
  $('.border-all input[type="checkbox"]').each(function () {
    if ($(this).prop("checked") == true) {
      ...
      $("#borderHrColor, #borderBottomColor")
        .next(".color-slelector")
        .css("background", "#" + borderTopColor);
  ...
  var colorInput = $(
    "#textColor, #topColor, #bottomColor, #bgColor, #borderTopColor, #borderHrColor, #borderBottomColor"
  );
  ...
  var colorSelector = $(
    "#colorSelector1, #colorSelector2, #colorSelector3, #colorSelector4, #colorSelector5, #colorSelector6, #colorSelector7"
  );
  ...
  // Inserting CSS
  $(
    '.colorpicker-submit, .button-state button, .border-all input[type="checkbox"]'
  ).click(function () {
    if ($('.button-color-option input[value="custom"]').is(":checked")) {
      ...
      if (
        resultButton.hasClass("active") ||
        resultButton.hasClass("disabled")
      ) {
        //alert(btnSelector);
        var btnStyle =
          "<style type='text/css'>" +
