...
$(function () {
  ...
  $(".button-color label").click(function () {
    ...
    var btnSize = $(".button-size label.active")
      .children("input")
      .attr("value");
    var btnState = $(".button-state label.active")
      .children("input")
      .attr("value");
    var btnWidth = $(".button-width label.active")
      .children("input")
      .attr("value");
    if (btnState == "active" || btnState == "disabled") {
      ...
      if (btnWidth.length) {
        var className =
          btnColor + " " + btnSize + " " + btnState + " " + btnWidth;
      }
  ...
  $(".button-size label").click(function () {
    ...
    var btnColor = $(".button-color label.active")
      .children("input")
      .attr("value");
    var btnState = $(".button-state label.active")
      .children("input")
  ...
  $(".element-type label").click(function () {
    ...
    if (
      $("#result a.btn span").length === 0 &&
      $(".include-icon label.active input").val() == 1
    ) {
    ...
    if ($(this).children("input").attr("value") == "a") {
      ...
      $(".button-html").html(filterHTML(btnHTML));
      if (
        $(".include-icon label.active").children("input").attr("value") == "1"
      ) {
        $(".toggle").add("#iconOption").show();
      }
      if (
        $(".include-icon label.active").children("input").attr("value") == "0"
      ) {
        $("#iconOption").show();
      }
