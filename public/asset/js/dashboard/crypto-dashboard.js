...
var options = {
  ...
  colors: [zetaAdminConfig.secondary],
  fill: {
    type: "gradient",
    gradient: {
      shadeIntensity: 1,
...
var chart = new ApexCharts(document.querySelector("#litecoin-chart"), options);
chart.render();

// litecoin-chart end

// notification-chart start
var options = {
  series: [
    {
      name: "Series 1",
...
var chart = new ApexCharts(
  document.querySelector("#notification-chart"),
  options
);
chart.render();
// notification-chart end
...
var options = {
  ...
  plotOptions: {
    candlestick: {
      colors: {
        upward: zetaAdminConfig.primary,
        downward: zetaAdminConfig.secondary,
      },
      wick: {
        useFillColor: true,
      },
