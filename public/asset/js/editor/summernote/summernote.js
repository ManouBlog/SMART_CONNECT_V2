...
(function (global, factory) {
  ...
  var toolbar = renderer.create(
    '<div class="note-toolbar-wrapper"><div class="note-toolbar card-header" role="toolbar"></div></div>'
  );
  ...
  var checkbox = renderer.create(
    ...
    function ($node, options) {
      ...
      $node.html(
        [
          ' <input role="checkbox" type="checkbox" class="custom-control-input"' +
  ...
  var LinkDialog = /** @class */ (function () {
    ...
    LinkDialog.prototype.initialize = function () {
      ...
      var body = [
        '<div class="form-group note-form-group m-b-20">',
  ...
  var ImageDialog = /** @class */ (function () {
    ...
    ImageDialog.prototype.initialize = function () {
      ...
      var body = [
        '<div class="form-group note-form-group note-group-select-from-files m-b-20">',
        '<label class="note-form-label">' +
        ...
        imageLimitation,
        "</div>",
        '<div class="form-group note-group-image-url m-b-20" style="overflow:auto;">',
  ...
  var VideoDialog = /** @class */ (function () {
    ...
    VideoDialog.prototype.initialize = function () {
      var $container = this.options.dialogsInBody ? this.$body : this.$editor;
      var body = [
        '<div class="form-group note-form-group row-fluid m-b-20">',
        '<label class="note-form-label m-b-5">' +
          this.lang.video.url +
