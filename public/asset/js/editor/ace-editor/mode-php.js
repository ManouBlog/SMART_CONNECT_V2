    ...
    function (e, t, n) {
      ...
      var f = function () {
        ...
        for (var n in this.$rules)
          this.$rules[n].unshift.apply(this.$rules[n], e);
        this.embedRules(a, "php-", t, ["start"]), this.normalizeRules();
      };
      r.inherits(f, u),
        (t.PhpHighlightRules = f),
        (t.PhpLangHighlightRules = a);
    }
  ),
  define(
    ...
    function (e, t, n) {
      ...
      (function () {
        (this.getCompletions = function (e, t, n, r) {
          ...
          return i
            ? f(i, "tag-name") || f(i, "tag-open") || f(i, "end-tag-open")
              ? this.getTagCompletions(e, t, n, r)
              : f(i, "tag-whitespace") || f(i, "attribute-name")
  ...
  define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        o = e("./php_highlight_rules").PhpLangHighlightRules,
      ...
      var g = function (e) {
        ...
        p.call(this),
          (this.HighlightRules = s),
          this.createModeDelegates({ "js-": d, "css-": v, "php-": m });
      };
      r.inherits(g, p),
        function () {
          (this.tokenRe = new RegExp(
            ...
            (this.createWorker = function (e) {
              ...
              return (
                t.attachToDocument(e.getDocument()),
                this.inlinePhp && t.call("setOptions", [{ inline: !0 }]),
                t.on("error", function (t) {
                  e.setAnnotations(t.data);
                }),
                t.on("ok", function () {
