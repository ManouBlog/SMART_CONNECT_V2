(function () {
  function s(r) {
    ...
    if (!s.define || !s.define.packaged)
      (t.original = s.define), (s.define = t), (s.define.packaged = !0);
    if (!s.require || !s.require.packaged)
      (n.original = s.require), (s.require = i), (s.require.packaged = !0);
  }
  var ACE_NAMESPACE = "",
    e = (function () {
      return this;
  ...
  var t = function (e, n, r) {
      if (typeof e != "string") {
        t.original
          ? t.original.apply(window, arguments)
          : (console.error("dropping module because define wasn't a string."),
            console.trace());
        return;
      }
      arguments.length == 2 && (r = n),
        t.modules || ((t.modules = {}), (t.payloads = {})),
        (t.payloads[e] = r),
        (t.modules[e] = null);
    },
    n = function (e, t, r) {
    ...
    i = function (e, i) {
      ...
      if (!s) {
        ...
        if (typeof s == "function") {
          var o = {},
            u = { id: i, uri: "", exports: o, packaged: !0 },
            a = function (e, t) {
              return n(i, e, t);
            },
            f = s(a, o, u);
  ...
  define("ace/lib/dom", ["require", "exports", "module"], function (e, t, n) {
    ...
    (t.getDocumentHead = function (e) {
      ...
      (t.importCssString = function (n, i, s) {
        ...
        var o;
        s.createStyleSheet
          ? ((o = s.createStyleSheet()),
            (o.cssText = n),
            i && (o.owningElement.id = i))
          : ((o = s.createElementNS
              ? s.createElementNS(r, "style")
  ...
  define(
    ...
    function (e, t, n) {
      ...
      function o(e, t, n) {
        ...
        return !!o || n in r.FUNCTION_KEYS || n in r.PRINTABLE_KEYS
          ? e(t, o, n)
          : !1;
      }
      var r = e("./keys"),
      ...
      (t.addListener = function (e, t, n) {
        ...
        (t.addMultiMouseDownListener = function (e, n, r, s) {
          ...
          t.addListener(e, "mousedown", function (e) {
            ...
            if (i.isIE) {
              var c =
                Math.abs(e.clientX - u) > 5 || Math.abs(e.clientY - a) > 5;
              if (!f || c) o = 1;
              f && clearTimeout(f),
        ...
        (this.onMouseDown = function (e) {
          ...
          if (i !== 0) {
            var s = r.getSelectionRange(),
              o = s.isEmpty();
            o && r.selection.moveToPosition(n),
  ...
  define(
    ...
    function (e, t, n) {
      ...
      function u(e) {
        ...
        function c() {
          o && (o = clearTimeout(o)),
            f && (i.hide(), (f = null), t.removeEventListener("mousewheel", c));
        }
        function h(e) {
        ...
        for (var h = 0; h < c.length; h++) {
          ...
          for (var m = 0, g = v.length; m < g; m++) {
            ...
            y.name.indexOf("data-ace-") === 0 &&
              (i[l(y.name.replace(/^data-ace-/, ""))] = y.value);
          }
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/event"),
        ...
        l = function (e) {
          ...
          var n = function (t) {
              !e.isFocused() && e.textInput && e.textInput.moveToMouse(t),
                e.focus();
            },
          ...
          r.addListener(u, "click", this.onMouseEvent.bind(this, "click")),
            ...
            e.renderer.scrollBarV &&
              ...
              i.isIE &&
                ...
                r.addListener(e.renderer.scrollBarH.element, "mousemove", n))),
          ...
          r.addListener(
            ...
            r.addListener(f, "mousedown", function (t) {
        ...
        r.implement(this, s),
          ...
          (this.moveCursorBy = function (e, t) {
            ...
            e !== 0 &&
              t === 0 &&
              r.row === this.lead.row &&
              r.column === this.lead.column &&
              this.session.lineWidgets &&
              this.session.lineWidgets[r.row] &&
              r.row++,
        ...
        (this.getLineTokens = function (e, t) {
          ...
          while ((a = u.exec(e))) {
            ...
            for (var y = 0; y < a.length - 2; y++) {
              ...
              (d = s[o[y]]),
                d.onMatch ? (p = d.onMatch(v, i, n)) : (p = d.token),
                d.next &&
            ...
            for (var i = 0; i < r.length; i++) {
              ...
              if (s.next || s.onMatch)
                typeof s.next != "string"
                  ...
                  : s.next.indexOf(t) !== 0 && (s.next = t + s.next);
            }
            this.$rules[t + n] = r;
          }
        }),
            ...
            for (var u = 0; u < o.length; u++) {
              ...
              if (a.rules)
                for (var c in a.rules)
                  r[c]
                    ? r[c].push && r[c].push.apply(r[c], a.rules[c])
                    : (r[c] = a.rules[c]);
            ...
            if (!this.lineCommentStart) {
                ...
                v = function (e, t) {
                  ...
                  if (!s || /\S/.test(e))
                    i.insertInLine({ row: t, column: e.length }, h),
                      i.insertInLine({ row: t, column: a }, c);
                },
                m = function (e, t) {
                  var n;
                  (n = e.match(d)) &&
              ...
              var m = function (e, t) {
                ...
                v = function (e, t) {
                  if (!s || /\S/.test(e))
                    b(e, a, a)
                      ? i.insertInLine({ row: t, column: a }, y)
                      : i.insertInLine({ row: t, column: a }, c);
                },
                g = function (e, t) {
                  return p.test(e);
        ...
        (this.getFoldAt = function (e, t, n) {
          ...
          (this.getCommentFoldRange = function (e, t, n) {
            ...
            if (s && /^comment|string/.test(s.type)) {
              ...
              return (
                (u.end.row = i.getCurrentTokenRow()),
            ...
            if (t.siblings) {
              ...
              t.children
                ? ((f = o ? o.end.row : this.getLength()),
                  this.foldAll(e + 1, o.end.row, t.all ? 1e4 : 0))
                : o &&
        ...
        r.implement(this, o),
          ...
          (this.onChange = function (e) {
            ...
            !this.$fromUndo &&
              ...
              n &&
                n.length != 0 &&
                this.$deltasFold.push({ action: "removeFolds", folds: n }),
          ...
          (this.$startWorker = function () {
            try {
              ...
              typeof console == "object" &&
                (console.log("Could not load worker"), console.log(e)),
                (this.$worker = null);
            }
          }),
          ...
          (this.$moveLines = function (e, t, n) {
            ...
            return (
              this.doc.insertLines(e + i, u), o.length && this.addFolds(o), i
            );
          }),
          ...
          (this.$updateInternalDataOnChange = function (e) {
            var t = this.$useWrapMode,
              ...
              a = null;
            r.indexOf("Lines") != -1
              ? (r == "insertLines" ? (s = i + e.data.lines.length) : (s = i),
            ...
            if (n != 0)
              if (r.indexOf("remove") != -1) {
                ...
                if (l) {
                  ...
                  v == 0
                    ? ((l = l.split(o.row, o.column)),
                      l &&
                        (l.shiftRow(n),
                        l.addRemoveChars(s, 0, u.column - o.column)))
                    : v == -1 &&
                      (l.addRemoveChars(i, 0, u.column - o.column),
                      l.shiftRow(n)),
                    (c = f.indexOf(l) + 1);
                }
                for (c; c < f.length; c++) {
            ...
            if (this.$useWrapMode) {
              ...
              if (v) {
                ...
                (s = v[m]),
                  m > 0 &&
                    v.length &&
                    ((i = v[m - 1] || v[v.length - 1]), (n = n.substring(i)));
              }
            }
            return (
              (i += this.$getStringScreenWidth(n, t)[1]),
          ...
          (this.addCommand = function (e) {
            ...
            (this._addCommandToBinding = function (e, t, n) {
              var r = this.commandKeyBinding,
                i;
              t
                ? !r[e] || this.$singleCommand
                  ? (r[e] = t)
                  : (Array.isArray(r[e])
                      ? (i = r[e].indexOf(t)) != -1 && r[e].splice(i, 1)
                      : (r[e] = [r[e]]),
                    n || t.isDefault ? r[e].unshift(t) : r[e].push(t))
                : delete r[e];
            }),
            ...
            (this.handleKeyboard = function (e, t, n, r) {
              ...
              return e.$keyChain && r > 0 && (e.$keyChain = ""), { command: o };
            });
        }.call(o.prototype),
        (t.HashHandler = o),
  ...
  define(
    ...
    function (e, t, n) {
      ...
      t.commands = [
        ...
        {
          name: "foldall",
          bindKey: o("Ctrl-Alt-0", "Ctrl-Command-Option-0"),
          exec: function (e) {
            e.session.foldAll();
          },
          scrollIntoView: "center",
      ...
      (function () {
        r.implement(this, d),
              ...
              if (t && t.scrollIntoView) {
                switch (t.scrollIntoView) {
                  ...
                  case "selectionPart":
                    ...
                    (n.start.row >= r.lastRow || n.end.row <= r.firstRow) &&
          ...
          (this.removeLines = function () {
            var e = this.$getSelectedRows(),
              t;
            e.first === 0 || e.last + 1 < this.session.getLength()
        ...
        i.implement(this, o),
          ...
          (this.update = function (e) {
            ...
            for (;;) {
              ...
              (p = this.$cells[++d]),
                p ||
                  ((p = { element: null, textNode: null, foldWidget: null }),
                  (p.element = r.createElement("div")),
              ...
              a[v] && (m += a[v]),
                f[v] && (m += f[v]),
                this.$annotations[v] && (m += this.$annotations[v].className),
              ...
              if (y) {
                p.foldWidget ||
                  ((p.foldWidget = r.createElement("span")),
                  p.element.appendChild(p.foldWidget));
                var m = "ace_fold-widget ace_" + y;
                y == "start" && v == o && v < s.end.row
                  ? (m += " ace_closed")
                  : (m += " ace_open"),
                  p.foldWidget.className != m && (p.foldWidget.className = m);
                var g = e.lineHeight + "px";
                p.foldWidget.style.height != g &&
                  (p.foldWidget.style.height = g);
              } else
                p.foldWidget &&
                  (p.element.removeChild(p.foldWidget), (p.foldWidget = null));
            ...
            var w = h
                ? h.getWidth(t, c, e)
                : c.toString().length * e.characterWidth,
            ...
            (w += E.left + E.right),
              w !== this.gutterWidth &&
                ...
                this._emit("changeGutterWidth", w));
          }),
          (this.$fixedWidth = !1),
            ...
            for (var n in this.markers) {
              ...
              if (r.renderer) {
                ...
                r.type == "fullLine"
                  ...
                  : this.drawSingleLineMarker(t, i, r.clazz + " ace_start", e);
            }
      ...
      var r = e("../lib/dom"),
        ...
        s = function (e) {
          (this.element = r.createElement("div")),
            ...
            e.appendChild(this.element),
            i === undefined && (i = "opacity" in this.element),
            (this.isVisible = !1),
            (this.isBlinking = !0),
      ...
      (function () {
        r.implement(this, u),
          ...
          (this.setPolling = function (e) {
            e
              ? this.$pollSizeChanges()
              : this.$pollSizeChangesTimer && this.$pollSizeChangesTimer;
          }),
        ...
        (this.CHANGE_CURSOR = 1),
          ...
          (this.$moveTextAreaToCursor = function () {
            ...
            (n -= this.scrollLeft),
              ...
              (this.textarea.style.left =
                Math.min(n, this.$size.scrollerWidth - i) + "px"),
              (this.textarea.style.top =
                Math.min(t, this.$size.height - r) + "px");
          }),
          (this.getFirstVisibleRow = function () {
          ...
          (this.$computeLayerConfig = function () {
            ...
            var e = this.session,
              ...
              a =
                ...
                (this.$hScrollBarAlwaysVisible ||
                  t.scrollerWidth - u - 2 * this.$padding < 0),
            ...
            (i += l),
              this.session.setScrollTop(
                Math.max(
                  ...
                  Math.min(
                    this.scrollTop,
                    i - t.scrollerHeight + this.scrollMargin.bottom
                  )
                )
              ),
            ...
            var p = Math.ceil(o / this.lineHeight) - 1,
              d = Math.max(
                0,
                Math.round((this.scrollTop - s) / this.lineHeight)
              ),
              v = d + p,
              m,
              g,
            ...
            b && (d = b.start.row),
              (m = e.documentToScreenRow(d, 0)),
              (g = e.getRowLength(d) * y),
              (v = Math.min(e.screenToDocumentRow(v, 0), e.getLength() - 1)),
              (o = t.scrollerHeight + e.getRowLength(v) * y + g),
              (s = this.scrollTop - m * y);
            var w = 0;
            this.layerConfig.width != u && (w = this.CHANGE_H_SCROLL);
            if (f || h)
              (w = this.$updateCachedSize(
                !0,
                this.gutterWidth,
                t.width,
                t.height
            ...
            return (
              (this.layerConfig = {
                ...
                gutterOffset: Math.max(
                  0,
                  Math.ceil((s + t.height - t.scrollerHeight) / y)
                ),
          ...
          (this.scrollCursorIntoView = function (e, t, n) {
            ...
            var r = this.$cursorLayer.getPixelPosition(e),
              ...
              a = this.$scrollAnimation
                ...
                : this.scrollTop;
            a + o > s
              ? (t && (s -= t * this.$size.scrollerHeight),
      ...
      (function () {
        r.implement(this, s),
          ...
          (this.$sendDeltaQueue = function () {
            ...
            if (!e) return;
            (this.deltaQueue = null),
              e.length > 20 && e.length > this.$doc.getLength() >> 1
            ...
            (this.selectionBefore = n.selection.toJSON()),
              ...
              this.pos.on("change", function (t) {
                n.removeMarker(e.markerId),
                  (e.markerId = n.addMarker(
                    new r(
                      t.value.row,
                      t.value.column,
                      t.value.row,
                      t.value.column + e.length
                    ),
                    e.mainClass,
                    null,
                    !1
          ...
          (this.onUpdate = function (e) {
            ...
            var i =
              t.action === "insertText"
                ...
                : n.start.column - n.end.column;
            if (
              n.start.column >= this.pos.column &&
              n.start.column <= this.pos.column + this.length + 1
            ) {
                ...
                if (t.action === "insertText")
                  ...
                  for (var o = this.others.length - 1; o >= 0; o--) {
                    ...
                    u.row === n.start.row &&
                      ...
                      (a.column += i),
                      this.doc.remove(
                        new r(a.row, a.column, a.row, a.column - i)
                      );
                  }
                n.start.column === this.pos.column && t.action === "insertText"
                  ? setTimeout(
                      function () {
                        this.pos.setPosition(this.pos.row, this.pos.column - i);
                        for (var e = 0; e < this.others.length; e++) {
                          var t = this.others[e],
                            r = { row: t.row, column: t.column - i };
                          t.row === n.start.row &&
                            n.start.column < t.column &&
                            (r.column += i),
      ...
      function o(e) {
        ...
        if (S == "add") {
          ...
          l.$blockScrolling++,
            ...
            o && ((T = null), (x = c.ranges[0]), l.removeSelectionMarker(x)),
        ...
        function () {
          (this.ranges = null),
            ...
            (this.rectangularRangeBlock = function (e, t, n) {
              ...
              for (var c = f; c <= l; c++) {
                var h = i.fromPoints(
                  this.session.screenToDocumentPosition(c, o),
                  this.session.screenToDocumentPosition(c, u)
                );
                if (h.isEmpty()) {
