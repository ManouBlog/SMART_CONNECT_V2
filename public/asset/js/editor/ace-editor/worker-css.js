    ...
    function (require, exports, module) {
      ...
      function clone(e, t, n, r) {
        function u(e, n) {
          ...
          if (util.isArray(e)) a = [];
          else if (util.isRegExp(e))
            (a = new RegExp(e.source, util.getRegExpFlags(e))),
              e.lastIndex && (a.lastIndex = e.lastIndex);
          else if (util.isDate(e)) a = new Date(e.getTime());
          else {
      ...
      (function () {
        ...
        function i(e, n) {
          (this._reader = e ? new t(e.toString()) : null),
            (this._token = null),
            (this._tokenData = n),
            (this._lt = []),
            (this._ltIndex = 0),
        ...
        (e.prototype = {
          ...
          (t.prototype = {
            ...
            readTo: function (e) {
              ...
              while (
                t.length < e.length ||
                t.lastIndexOf(e) != t.length - e.length
              ) {
                n = this.read();
                if (!n)
                  throw new Error(
            ...
            readMatch: function (e) {
              ...
              return (
                typeof e == "string"
                  ? t.indexOf(e) === 0 && (n = this.readCount(e.length))
                  : e instanceof RegExp &&
                    e.test(t) &&
                    (n = this.readCount(RegExp.lastMatch.length)),
                n
              );
            },
            ...
            get: function (e) {
              ...
              if (
                ...
                while (
                  ...
                  (this._token = this._lt[this._ltIndex++]),
                    ...
                    i++;
                if (
                  (a.channel === undefined || e === a.channel) &&
                  this._ltIndex <= this._lt.length
                )
              ...
              return (
                ...
                u.type > -1 &&
                  ...
                  (this._ltIndex = this._lt.length)),
                (a = t[u.type]),
                a && (a.hide || (a.channel !== undefined && e !== a.channel))
                  ? this.get(e)
                  : u.type
              );
            },
        ...
        (function () {
          ...
          function PropertyName(e, t, n, r) {
            SyntaxUnit.call(this, e, n, r, Parser.PROPERTY_NAME_TYPE),
              (this.hack = t);
          }
          ...
          function PropertyValuePart(text, line, col) {
            SyntaxUnit.call(
              ...
              line,
              col,
              Parser.PROPERTY_VALUE_PART_TYPE
            ),
              (this.type = "unknown");
            var temp;
          ...
          function SelectorPart(e, t, n, r, i) {
            SyntaxUnit.call(this, n, r, i, Parser.SELECTOR_PART_TYPE),
              (this.elementName = e),
              (this.modifiers = t);
          }
          function SelectorSubPart(e, t, n, r) {
            SyntaxUnit.call(this, e, n, r, Parser.SELECTOR_SUB_PART_TYPE),
              (this.type = t),
              (this.args = []);
          }
                ...
                n = {
                  ...
                  _stylesheet: function () {
                    ...
                    while (i > Tokens.EOF) {
                      try {
                        switch (i) {
                          ...
                          case Tokens.UNKNOWN_SYM:
                            ...
                            this.fire({
                              ...
                              (n = 0);
                            while (
                              e.advance([Tokens.LBRACE, Tokens.RBRACE]) ==
                              Tokens.LBRACE
                            )
                              n++;
                        ...
                        if (!(s instanceof SyntaxError && !this.options.strict))
                          throw s;
                        this.fire({
                          type: "error",
                          error: s,
                    ...
                    i != Tokens.EOF && this._unexpectedToken(e.token()),
                  ...
                  _charset: function (e) {
                    var t = this._tokenStream,
                      ...
                      i,
                      s;
                    t.match(Tokens.CHARSET_SYM) &&
                      ((i = t.token().startLine),
                      (s = t.token().startCol),
                      this._readWhitespace(),
                      t.mustMatch(Tokens.STRING),
                      (r = t.token()),
                      (n = r.value),
                      this._readWhitespace(),
                      t.mustMatch(Tokens.SEMICOLON),
                      e !== !1 &&
                        this.fire({
                          type: "charset",
                          charset: n,
                  ...
                  _import: function (e) {
                    var t = this._tokenStream,
                      ...
                      i,
                      s = [];
                    t.mustMatch(Tokens.IMPORT_SYM),
                      (i = t.token()),
                      this._readWhitespace(),
                      t.mustMatch([Tokens.STRING, Tokens.URI]),
                      (r = t
                        .token()
                        .value.replace(
                          /^(?:url\()?["']?([^"']+?)["']?\)?$/,
                  ...
                  _namespace: function (e) {
                    var t = this._tokenStream,
                      ...
                      i,
                      s;
                    t.mustMatch(Tokens.NAMESPACE_SYM),
                      (n = t.token().startLine),
                      (r = t.token().startCol),
                      this._readWhitespace(),
                      t.match(Tokens.IDENT) &&
                        ((i = t.token().value), this._readWhitespace()),
                      t.mustMatch([Tokens.STRING, Tokens.URI]),
                      (s = t
                        .token()
                        .value.replace(/(?:url\()?["']([^"']+)["']\)?/, "$1")),
                  ...
                  _media: function () {
                    ...
                    for (;;)
                      ...
                      else if (e.peek() == Tokens.FONT_FACE_SYM)
                        this._font_face();
                      else if (e.peek() == Tokens.VIEWPORT_SYM)
                        this._viewport();
                      else if (!this._ruleset()) break;
                    e.mustMatch(Tokens.RBRACE),
                      this._readWhitespace(),
                      this.fire({
                        type: "endmedia",
                        media: r,
                  ...
                  _media_query_list: function () {
                    var e = this._tokenStream,
                      t = [];
                    this._readWhitespace(),
                      (e.peek() == Tokens.IDENT || e.peek() == Tokens.LPAREN) &&
                  ...
                  _media_query: function () {
                    var e = this._tokenStream,
                      ...
                      r = null,
                      i = [];
                    e.match(Tokens.IDENT) &&
                      ((n = e.token().value.toLowerCase()),
                      n != "only" && n != "not"
                        ? (e.unget(), (n = null))
                        : (r = e.token())),
                      this._readWhitespace(),
                  ...
                  _media_expression: function () {
                    var e = this._tokenStream,
                      ...
                      r = null;
                    return (
                      e.mustMatch(Tokens.LPAREN),
                      (t = this._media_feature()),
                      this._readWhitespace(),
                      e.match(Tokens.COLON) &&
                        (this._readWhitespace(),
                        (n = e.LT(1)),
                        (r = this._expression())),
                      e.mustMatch(Tokens.RPAREN),
                      this._readWhitespace(),
                      new MediaFeature(
                        t,
                        r ? new SyntaxUnit(r, n.startLine, n.startCol) : null
                      )
                    );
                  },
                  _media_feature: function () {
                    var e = this._tokenStream;
                    return (
                      e.mustMatch(Tokens.IDENT), SyntaxUnit.fromToken(e.token())
                    );
                  },
                  _page: function () {
                    var e = this._tokenStream,
                    ...
                    e.mustMatch(Tokens.PAGE_SYM),
                      ...
                      e.match(Tokens.IDENT) &&
                        ...
                        r.toLowerCase() === "auto" &&
                          this._unexpectedToken(e.token())),
                      e.peek() == Tokens.COLON && (i = this._pseudo_page()),
                      this._readWhitespace(),
                      this.fire({
                        type: "startpage",
                        id: r,
                  ...
                  _margin_sym: function () {
                    ...
                    return e.match([
                      ...
                      ? SyntaxUnit.fromToken(e.token())
                      : null;
                  },
                  _pseudo_page: function () {
                    var e = this._tokenStream;
                    return (
                      e.mustMatch(Tokens.COLON),
                      e.mustMatch(Tokens.IDENT),
                      e.token().value
                    );
                  },
                  _font_face: function () {
                    var e = this._tokenStream,
                      t,
                      n;
                    e.mustMatch(Tokens.FONT_FACE_SYM),
                      (t = e.token().startLine),
                      (n = e.token().startCol),
                      this._readWhitespace(),
                      this.fire({ type: "startfontface", line: t, col: n }),
                      this._readDeclarations(!0),
                      this.fire({ type: "endfontface", line: t, col: n });
                  },
                  _viewport: function () {
                    var e = this._tokenStream,
                      t,
                      n;
                    e.mustMatch(Tokens.VIEWPORT_SYM),
                      (t = e.token().startLine),
                      (n = e.token().startCol),
                      this._readWhitespace(),
                      this.fire({ type: "startviewport", line: t, col: n }),
                      this._readDeclarations(!0),
                      this.fire({ type: "endviewport", line: t, col: n });
                  },
                  _operator: function (e) {
                    var t = this._tokenStream,
                      n = null;
                    if (
                      t.match([Tokens.SLASH, Tokens.COMMA]) ||
                      (e && t.match([Tokens.PLUS, Tokens.STAR, Tokens.MINUS]))
                    )
                  ...
                  _combinator: function () {
                    var e = this._tokenStream,
                      ...
                      n;
                    return (
                      e.match([Tokens.PLUS, Tokens.GREATER, Tokens.TILDE]) &&
                        ((n = e.token()),
                        (t = new Combinator(n.value, n.startLine, n.startCol)),
                        this._readWhitespace()),
                      t
                    );
                  },
                  _unary_operator: function () {
                    var e = this._tokenStream;
                    return e.match([Tokens.MINUS, Tokens.PLUS])
                      ? e.token().value
                      : null;
                  },
                  _property: function () {
                    ...
                    do {
                      ...
                      if (r !== null)
                        ...
                        (i = new Combinator(
                          ...
                          (n = this._simple_selector_sequence()),
                          n === null
                            ? r !== null && this._unexpectedToken(e.LT(1))
                            : (r !== null ? t.push(r) : t.push(i), t.push(n));
                      }
                    } while (!0);
                  ...
                  _namespace_prefix: function () {
                    var e = this._tokenStream,
                      t = "";
                    if (e.LA(1) === Tokens.PIPE || e.LA(2) === Tokens.PIPE)
                      e.match([Tokens.IDENT, Tokens.STAR]) &&
                        (t += e.token().value),
                        e.mustMatch(Tokens.PIPE),
                        (t += "|");
                    return t.length ? t : null;
                  },
                  _viho: function () {
                  ...
                  _attrib: function () {
                    var e = this._tokenStream,
                      ...
                      n,
                      r;
                    return e.match(Tokens.LBRACKET)
                      ? ((r = e.token()),
                        (t = r.value),
                        ...
                        e.match([
                          ...
                          ((t += e.token().value),
                          (t += this._readWhitespace()),
                          e.mustMatch([Tokens.IDENT, Tokens.STRING]),
                          (t += e.token().value),
                          (t += this._readWhitespace())),
                        e.mustMatch(Tokens.RBRACKET),
                        new SelectorSubPart(
                          t + "]",
                          "attribute",
                          r.startLine,
                  ...
                  _pseudo: function () {
                    ...
                    return (
                      e.match(Tokens.COLON) &&
                        (e.match(Tokens.COLON) && (n += ":"),
                        e.match(Tokens.IDENT)
                          ? ((t = e.token().value),
                            (r = e.token().startLine),
                            (i = e.token().startCol - n.length))
                          : e.peek() == Tokens.FUNCTION &&
                            ((r = e.LT(1).startLine),
                            (i = e.LT(1).startCol - n.length),
                            (t = this._functional_pseudo())),
                        t && (t = new SelectorSubPart(n + t, "pseudo", r, i))),
                      t
                    );
                  },
                  ...
                  _negation: function () {
                    ...
                    return (
                      e.match(Tokens.NOT) &&
                        ...
                        (i = this._negation_arg()),
                        (r += i),
                        (r += this._readWhitespace()),
                        e.match(Tokens.RPAREN),
                        (r += e.token().value),
                        (s = new SelectorSubPart(r, "not", t, n)),
                        s.args.push(i)),
                      s
                    );
                  },
                  _negation_arg: function () {
                    ...
                    return (
                      n === null && this._unexpectedToken(e.LT(1)),
                      n.type == "elementName"
                        ? (a = new SelectorPart(n, [], n.toString(), o, u))
                        : (a = new SelectorPart(null, [n], n.toString(), o, u)),
                      a
                    );
                  },
                  _declaration: function () {
                    ...
                    if (t !== null) {
                      ...
                      if (
                        ...
                        (this.options.underscoreHack && t.hack == "_")
                      )
                        o = t.text;
                      try {
                  ...
                  _expr: function (e) {
                    ...
                    return n.length > 0
                      ? new PropertyValue(n, n[0].line, n[0].col)
                      : null;
                  },
                  _term: function (e) {
                    var t = this._tokenStream,
                      ...
                      u;
                    return (
                      (n = this._unary_operator()),
                      n !== null &&
                        ((o = t.token().startLine), (u = t.token().startCol)),
                      t.peek() == Tokens.IE_FUNCTION && this.options.ieFilters
                        ? ((r = this._ie_function()),
                          n === null &&
                            ((o = t.token().startLine),
                            (u = t.token().startCol)))
                  ...
                  _function: function () {
                    ...
                    if (e.match(Tokens.FUNCTION)) {
                      ...
                      if (this.options.ieFilters && e.peek() == Tokens.EQUALS)
                        do {
                          this._readWhitespace() && (t += e.token().value),
                            e.LA(0) == Tokens.COMMA && (t += e.token().value),
                            e.match(Tokens.IDENT),
                            (t += e.token().value),
                            e.match(Tokens.EQUALS),
                            (t += e.token().value),
                            (r = e.peek());
                          while (
                            r != Tokens.COMMA &&
                  ...
                  _keyframes: function () {
                    var e = this._tokenStream,
                      ...
                      r,
                      i = "";
                    e.mustMatch(Tokens.KEYFRAMES_SYM),
                      (t = e.token()),
                      /^@\-([^\-]+)\-/.test(t.value) && (i = RegExp.$1),
                      this._readWhitespace(),
                  ...
                  _key: function () {
                    var e = this._tokenStream,
                      t;
                    if (e.match(Tokens.PERCENTAGE))
                      return SyntaxUnit.fromToken(e.token());
                    if (e.match(Tokens.IDENT)) {
                      t = e.token();
                      if (/from|to/i.test(t.value))
                        return SyntaxUnit.fromToken(t);
                      e.unget();
                    }
                    this._unexpectedToken(e.LT(1));
                  },
                  ...
                  _readDeclarations: function (e, t) {
                    var n = this._tokenStream,
                      r;
                    this._readWhitespace(),
                      e && n.mustMatch(Tokens.LBRACE),
                      this._readWhitespace();
                    try {
                      for (;;) {
                        if (
                          !(n.match(Tokens.SEMICOLON) || (t && this._margin()))
                        ) {
                      ...
                      if (!(i instanceof SyntaxError && !this.options.strict))
                        throw i;
                      this.fire({
                        type: "error",
                        error: i,
                      ...
                      if (r == Tokens.SEMICOLON) this._readDeclarations(!1, t);
                      else if (r != Tokens.RBRACE) throw i;
                    }
                  },
          ...
          var Properties = {
            ...
            appearance:
              "icon | window | desktop | workspace | document | tooltip | dialog | button | push-button | hyperlink | radio-button | checkbox | menu-item | tab | menu | menubar | pull-down-menu | pop-up-menu | list-menu | radio-group | checkbox-group | outline-tree | range | field | combo-box | signature | password | normal | none | inherit",
            azimuth: function (e) {
              var t = "<angle> | leftwards | rightwards | inherit",
                ...
                i = !1,
                s;
              ValidationTypes.isAny(e, t) ||
                (ValidationTypes.isAny(e, "behind") && ((r = !0), (i = !0)),
                ValidationTypes.isAny(e, n) &&
                  ((i = !0), r || ValidationTypes.isAny(e, "behind")));
              if (e.hasNext())
                throw (
                  ((s = e.next()),
                  i
                    ? new ValidationError(
                        "Expected end of value but found '" + s + "'.",
                        s.line,
                        s.col
                      )
                    : new ValidationError(
                        "Expected (<'azimuth'>) but found '" + s + "'.",
                        s.line,
                        s.col
                      ))
                );
            ...
            "border-image-slice": function (e) {
              ...
              if (e.hasNext())
                throw (
                  ...
                  t
                    ? new ValidationError(
                        "Expected end of value but found '" + o + "'.",
                        o.line,
                        o.col
                      )
                    : new ValidationError(
            ...
            "border-radius": function (e) {
              ...
              if (e.hasNext())
                throw (
                  ...
                  t
                    ? new ValidationError(
                        "Expected end of value but found '" + u + "'.",
                        u.line,
                        u.col
                      )
                    : new ValidationError(
                        "Expected (<'border-radius'>) but found '" + u + "'.",
                        u.line,
                        u.col
                      ))
                );
            ...
            "box-shadow": function (e) {
              var t = !1,
                n;
              if (!ValidationTypes.isAny(e, "none"))
                Validation.multiProperty("<shadow>", e, !0, Infinity);
              else if (e.hasNext())
                throw (
                  ((n = e.next()),
                  new ValidationError(
                    "Expected end of value but found '" + n + "'.",
                    n.line,
                    n.col
                  ))
                );
            ...
            "marquee-style": 1,
            "max-height":
              "<length> | <percentage> | <content-sizing> | none | inherit",
            "max-width":
              "<length> | <percentage> | <content-sizing> | none | inherit",
            "min-height":
            ...
            volume: 1,
            "white-space":
              "normal | pre | nowrap | pre-wrap | pre-line | inherit | -pre-wrap | -o-pre-wrap | -moz-pre-wrap | -hp-pre-wrap",
            "white-space-collapse": 1,
            widows: "<integer> | inherit",
            width:
              "<length> | <percentage> | <content-sizing> | auto | inherit",
          ...
          (PropertyName.prototype = new SyntaxUnit()),
            ...
            (PropertyValuePart.fromToken = function (e) {
          ...
          (Pseudos.ELEMENT = 1),
            (Pseudos.CLASS = 2),
            (Pseudos.isElement = function (e) {
              return (
                e.indexOf("::") === 0 ||
                Pseudos[e.toLowerCase()] == Pseudos.ELEMENT
              );
            }),
            ...
            (Specificity.calculate = function (e) {
              ...
              var t,
                ...
                s = 0,
                o = 0;
              for (t = 0, n = e.parts.length; t < n; t++)
                (r = e.parts[t]), r instanceof SelectorPart && u(r);
          ...
          TokenStream.prototype = mix(new TokenStreamBase(), {
            _getToken: function (e) {
              ...
              return (
                !r &&
                  t === null &&
                  (r = this.createToken(Tokens.EOF, null, i, s)),
                r
              );
            },
            ...
            atRuleToken: function (e, t, n) {
              ...
              if (s == Tokens.CHAR || s == Tokens.UNKNOWN)
                r.length > 1
                  ? (s = Tokens.UNKNOWN_SYM)
                  : ((s = Tokens.CHAR), (r = e), i.reset());
            ...
            charToken: function (e, t, n) {
              var r = Tokens.type(e),
                i = {};
              return (
                r == -1 ? (r = Tokens.CHAR) : (i.endChar = Tokens[r].endChar),
                this.createToken(r, e, t, n, i)
              );
            },
            ...
            htmlCommentStartToken: function (e, t, n) {
              ...
              return (
                ...
                (i += r.readCount(3)),
                i == "<!--"
                  ? this.createToken(Tokens.CDO, i, t, n)
            ...
            htmlCommentEndToken: function (e, t, n) {
              ...
              return (
                ...
                (i += r.readCount(2)),
                i == "-->"
                  ? this.createToken(Tokens.CDC, i, t, n)
                  : (r.reset(), this.charToken(e, t, n))
              );
            },
                ...
                r.peek() == "("
                  ? ((i += r.read()),
                    i.toLowerCase() == "url("
                      ? ((s = Tokens.URI),
                        (i = this.readURI(i)),
                        i.toLowerCase() == "url(" && (s = Tokens.FUNCTION))
                      : (s = Tokens.FUNCTION))
                  : r.peek() == ":" &&
                    i.toLowerCase() == "progid" &&
                    ((i += r.readTo("(")), (s = Tokens.IE_FUNCTION)),
                this.createToken(s, i, t, n)
              );
            },
            ...
            notToken: function (e, t, n) {
              ...
              return (
                ...
                (i += r.readCount(4)),
                i.toLowerCase() == ":not("
                  ? this.createToken(Tokens.NOT, i, t, n)
                  : (r.reset(), this.charToken(e, t, n))
              );
            },
            ...
            stringToken: function (e, t, n) {
              ...
              return (
                a === null && (u = Tokens.INVALID), this.createToken(u, i, t, n)
              );
            },
            unicodeRangeToken: function (e, t, n) {
              ...
              return (
                r.peek() == "+" &&
                  (r.mark(),
                  (i += r.read()),
                  (i += this.readUnicodeRangePart(!0)),
                  i.length == 2
                    ? r.reset()
                    : ((o = Tokens.UNICODE_RANGE),
                      i.indexOf("?") == -1 &&
                        r.peek() == "-" &&
                        (r.mark(),
                        (s = r.read()),
                        (s += this.readUnicodeRangePart(!1)),
                        s.length == 1 ? r.reset() : (i += s)))),
                this.createToken(o, i, t, n)
              );
            },
            ...
            for (var n = 0, r = Tokens.length; n < r; n++) {
              ...
              if (Tokens[n].text)
                if (Tokens[n].text instanceof Array)
                  for (var i = 0; i < Tokens[n].text.length; i++)
                    t[Tokens[n].text[i]] = n;
            ...
            multiProperty: function (e, t, n, r) {
              ...
              if (!i)
                throw t.hasNext() && !t.isFirst()
                  ? ((a = t.peek()),
                    new ValidationError(
                      "Expected end of value but found '" + a + "'.",
                      a.line,
                      a.col
                    ))
                  : ((a = t.previous()),
            ...
            groupProperty: function (e, t, n) {
              ...
              if (!r)
                throw u && t.hasNext()
                  ? ((f = t.peek()),
                    new ValidationError(
                      "Expected end of value but found '" + f + "'.",
                      f.line,
                      f.col
                    ))
                  : new ValidationError(
                      "Expected (" + e + ") but found '" + i + "'.",
                      i.line,
                      i.col
                    );
              if (t.hasNext())
          ...
          var ValidationTypes = {
            ...
            simple: {
              ...
              "<bg-image>": function (e) {
                return (
                  this["<image>"](e) || this["<gradient>"](e) || e == "none"
                );
              },
              "<gradient>": function (e) {
                return (
              ...
              "<border-width>": function (e) {
                return (
                  this["<length>"](e) ||
                  ValidationTypes.isLiteral(e, "thin | medium | thick")
                );
              },
              ...
              "<margin-width>": function (e) {
                return (
                  this["<length>"](e) ||
                  this["<percentage>"](e) ||
                  ValidationTypes.isLiteral(e, "auto")
                );
              },
            ...
            complex: {
              "<bg-position>": function (e) {
                ...
                return (
                  o < 3
                    ? ValidationTypes.isAny(e, i + " | center | " + r)
                      ? ((n = !0),
                        ValidationTypes.isAny(e, s + " | center | " + r))
              ...
              "<bg-size>": function (e) {
                var t = this,
                  ...
                  o;
                return (
                  ValidationTypes.isAny(e, "cover | contain")
                    ? (n = !0)
                    : ValidationTypes.isAny(e, r) &&
                      ((n = !0), ValidationTypes.isAny(e, r)),
                  n
              ...
              "<repeat-style>": function (e) {
                ...
                return (
                  e.hasNext() &&
                    ((r = e.next()),
                    ValidationTypes.isLiteral(r, "repeat-x | repeat-y")
                      ? (t = !0)
                      : ValidationTypes.isLiteral(r, n) &&
                        ((t = !0),
                        e.hasNext() &&
                          ValidationTypes.isLiteral(e.peek(), n) &&
                          e.next())),
                  t
                );
              },
              "<shadow>": function (e) {
                var t = !1,
                  ...
                  s;
                if (e.hasNext()) {
                  ValidationTypes.isAny(e, "inset") && (r = !0),
                    ValidationTypes.isAny(e, "<color>") && (i = !0);
                  while (ValidationTypes.isAny(e, "<length>") && n < 4) n++;
                  e.hasNext() &&
                    (i || ValidationTypes.isAny(e, "<color>"),
                    r || ValidationTypes.isAny(e, "inset")),
                    (t = n >= 2 && n <= 4);
                }
                return t;
              },
      ...
      var util = {
        isArray: function (e) {
          return (
            Array.isArray(e) ||
            (typeof e == "object" && objectToString(e) === "[object Array]")
          );
        },
        isDate: function (e) {
        ...
        isRegExp: function (e) {
          return (
            typeof e == "object" && objectToString(e) === "[object RegExp]"
          );
        },
      ...
      typeof module == "object" && (module.exports = clone),
      ...
      var CSSLint = (function () {
        ...
        var e = [],
          t = [],
          n = /\/\*csslint([^\*]*)\*\//,
          r = new parserlib.util.EventTarget();
        return (
          (r.version = "@VERSION@"),
          (r.addRule = function (t) {
            e.push(t), (e[t.id] = t);
          }),
          ...
          (r.verify = function (t, r) {
            ...
            try {
              ...
              o.error(
                "Fatal error, cannot continue: " + l.message,
                l.line,
                l.col,
                {}
              );
      ...
      (Reporter.prototype = {
        ...
        CSSLint.addRule({
          ...
          init: function (e, t) {
            ...
            e.addListener("startrule", u),
              ...
              e.addListener("startpage", u),
              e.addListener("startpagemargin", u),
              e.addListener("startkeyframerule", u),
              e.addListener("property", function (e) {
                var t = e.property.text.toLowerCase();
                i[t] || r[t]
                  ? !/^0\S*$/.test(e.value) &&
                    (t !== "border" || e.value.toString() !== "none") &&
                    (s[t] = {
        ...
        CSSLint.addRule({
          ...
          init: function (e, t) {
            ...
            e.addListener("startrule", function () {
              ...
              e.addListener("property", function (e) {
                var t = e.property;
                CSSLint.Util.indexOf(h, t.text) > -1 &&
                  (!l ||
                    typeof l != "string" ||
                    t.text.indexOf("-" + l + "-") !== 0) &&
                  i.push(t);
              ...
              e.addListener("endrule", function () {
                ...
                for (s = 0, o = i.length; s < o; s++) {
                  ...
                  for (a in r)
                    r.hasOwnProperty(a) &&
                      ((f = r[a]),
                      CSSLint.Util.indexOf(f, u.text) > -1 &&
                        (e[a] ||
                          (e[a] = {
                            full: f.slice(0),
                            actual: [],
                        ...
                        CSSLint.Util.indexOf(e[a].actual, u.text) === -1 &&
                          (e[a].actual.push(u.text),
                          e[a].actualNodes.push(u))));
                }
                for (a in e)
        ...
        CSSLint.addRule({
          ...
          init: function (e, t) {
            ...
            e.addListener("startrule", o),
              ...
              e.addListener("endkeyframerule", u),
              e.addListener("endpagemargin", u),
              e.addListener("endpage", u);
          },
        }),
        CSSLint.addRule({
            ...
            e.addListener("property", function (e) {
              ...
              if (i.match(/background/i))
                for (o = 0, u = s.parts.length; o < u; o++)
                  s.parts[o].type === "uri" &&
                    (typeof r[s.parts[o].uri] == "undefined"
                      ? (r[s.parts[o].uri] = e)
                      : t.report(
                          "Background image '" +
                            s.parts[o].uri +
                            "' was used multiple times, first declared at line " +
                            r[s.parts[o].uri].line +
                            ", col " +
                            r[s.parts[o].uri].col +
                            ".",
                          e.line,
        ...
        CSSLint.addRule({
          ...
          init: function (e, t) {
            ...
            e.addListener("startrule", s),
              ...
              e.addListener("property", function (e) {
                var s = e.property,
                  o = s.text.toLowerCase();
                r[o] &&
                  (i !== o || r[o] === e.value.text) &&
                  t.report(
            ...
            e.addListener("startrule", o),
              ...
              e.addListener("property", function (e) {
                ...
                if (i[o])
                  while (a < l)
                    u[a].type === "color" &&
                      ("alpha" in u[a] || "hue" in u[a]
                        ? (/([^\)]+)\(/.test(u[a]) &&
                            (f = RegExp.$1.toUpperCase()),
                          (!r ||
                            r.property.text.toLowerCase() !== o ||
                            r.colorType !== "compat") &&
                            t.report(
                              "Fallback " +
                                o +
        ...
        CSSLint.addRule({
          ...
          init: function (e, t) {
            var n = this,
              r = 0;
            e.addListener("property", function (e) {
              e.property.text.toLowerCase() === "float" &&
                e.value.text.toLowerCase() !== "none" &&
                r++;
            }),
          ...
          init: function (e, t) {
            ...
            e.addListener("startfontface", function () {
              ...
              e.addListener("endstylesheet", function () {
                r > 5 &&
                  t.rollupWarn(
                    "Too many @font-face declarations (" + r + ").",
                    n
                  );
              });
          },
          ...
          init: function (e, t) {
            ...
            e.addListener("startrule", function (r) {
              ...
              for (f = 0; f < i.length; f++) {
                ...
                a === 1
                  ? t.report("Don't use IDs in selectors.", s.line, s.col, n)
                  : a > 1 &&
                    t.report(
        ...
        CSSLint.addRule({
          ...
          init: function (e, t) {
            ...
            e.addListener("property", function (e) {
              e.important === !0 &&
                (r++, t.report("Use of !important", e.line, e.col, n));
            }),
              e.addListener("endstylesheet", function () {
                t.stat("important", r),
                  r >= 10 &&
        ...
        CSSLint.addRule({
          ...
          init: function (e, t) {
            ...
            function s() {
              r &&
                r.outline &&
                (r.selectors.toString().toLowerCase().indexOf(":focus") === -1
                  ? t.report(
            ...
            e.addListener("startrule", function (r) {
              ...
              for (u = 0; u < i.length; u++) {
                ...
                for (a = 0; a < s.parts.length; a++)
                  (o = s.parts[a]),
                    o.type === e.SELECTOR_PART_TYPE &&
                      o.elementName &&
                      /h[1-6]/.test(o.elementName.toString()) &&
                      a > 0 &&
                      t.report(
                        "Heading (" +
                          o.elementName +
        ...
        CSSLint.addRule({
          ...
          init: function (e, t) {
            ...
            e.addListener("startrule", f),
              e.addListener("startfontface", f),
              e.addListener("property", function (e) {
                var t = e.property.toString().toLowerCase();
                o[t] && (u[t] = 1);
              }),
          ...
          init: function (e, t) {
            ...
            e.addListener("startrule", s),
              ...
              e.addListener("property", function (e) {
                var t = e.property.toString().toLowerCase(),
                  n = e.value;
                t === "text-indent" && n.parts[0].value < -99
                  ? (r = e.property)
                  : t === "direction" && n.toString() === "ltr" && (i = "ltr");
              }),
        ...
        CSSLint.addRule({
          ...
          init: function (e, t) {
            var n = this,
              r = { h1: 0, h2: 0, h3: 0, h4: 0, h5: 0, h6: 0 };
            e.addListener("startrule", function (e) {
              var i = e.selectors,
                s,
                o,
              ...
              for (a = 0; a < i.length; a++) {
                ...
                if (
                  o.elementName &&
                  /(h[1-6])/i.test(o.elementName.toString())
                ) {
              ...
              e.addListener("endstylesheet", function () {
                ...
                i.length &&
                  t.rollupWarn(
                    "You have " + i.join(", ") + " defined in this stylesheet.",
                    n
                  );
              });
          },
        ...
        CSSLint.addRule({
          id: "viho-selector",
          name: "Disallow viho selector",
          desc: "The viho selector (*) is known to be slow.",
          browsers: "All",
          init: function (e, t) {
            var n = this;
            e.addListener("startrule", function (e) {
              ...
              for (o = 0; o < r.length; o++)
                (i = r[o]),
                  (s = i.parts[i.parts.length - 1]),
                  s.elementName === "*" && t.report(n.desc, s.line, s.col, n);
            });
          },
        }),
        CSSLint.addRule({
                  ...
                  for (f = 0; f < o.modifiers.length; f++)
                    (u = o.modifiers[f]),
                      u.type === "attribute" &&
                        ...
                        t.report(n.desc, o.line, o.col, n);
              }
            });
          },
        }),
          ...
          init: function (e, t) {
            ...
            e.addListener("startrule", o),
              ...
              e.addListener("property", function (e) {
                var t = e.property.text.toLowerCase();
                r[t] || (r[t] = []),
                  r[t].push({ name: e.property, value: e.value, pos: i++ });
              }),
              e.addListener("endrule", u),
              e.addListener("endfontface", u),
              e.addListener("endpage", u),
          ...
          CSSLint.addFormatter({
            ...
            formatResults: function (t, n) {
              var r = t.messages,
                ...
                s = function (e) {
                  return !!e && "name" in e
                    ? "net.csslint." + e.name.replace(/\s/g, "")
                    : "";
                };
              return (
                r.length > 0 &&
                  (i.push('<file name="' + n + '">'),
                  CSSLint.Util.forEach(r, function (t) {
                    t.rollup ||
                      i.push(
                        '<error line="' +
                          t.line +
          ...
          formatResults: function (e, t, n) {
            ...
            return r.length === 0
              ? n.quiet
                ? ""
                : t + ": Lint Free!"
              : (CSSLint.Util.forEach(r, function (e) {
                  e.rollup
                    ? (i += t + ": " + s(e.type) + " - " + e.message + "\n")
                    : (i +=
                        t +
                        ": " +
                        "line " +
        ...
        CSSLint.addFormatter({
          ...
          formatResults: function (e, t) {
            ...
            return (
              n.length > 0 &&
                (r.push('<file name="' + t + '">'),
                CSSLint.Util.forEach(n, function (e) {
                  e.rollup
                    ? r.push(
                        '<issue severity="' +
                          e.type +
            ...
            return (
              n.length > 0 &&
                (n.forEach(function (e) {
                  ...
                  e.rollup ||
                    (r.push('<testcase time="0" name="' + s(e.rule) + '">'),
                    r.push(
                      "<" +
                        t +
                        ' message="' +
        ...
        CSSLint.addFormatter({
          ...
          formatResults: function (e, t, n) {
            ...
            (i = "\n\ncsslint: There "),
              r.length === 1
                ? (i += "is 1 problem")
                : (i += "are " + r.length + " problems"),
              (i += " in " + t + ".");
            var s = t.lastIndexOf("/"),
              o = t;
            return (
              s === -1 && (s = t.lastIndexOf("\\")),
              s > -1 && (o = t.substring(s + 1)),
              CSSLint.Util.forEach(r, function (e, t) {
                (i = i + "\n\n" + o),
                  e.rollup
                    ? ((i += "\n" + (t + 1) + ": " + e.type),
                      (i += "\n" + e.message))
      ...
      var r = e("../lib/oop"),
        ...
        u = (t.Worker = function (e) {
          s.call(this, e),
            ...
            this.setInfoRules(
              "adjoining-classes|qualified-headings|zero-units|gradients|import|outline-none|vendor-prefix"
            );
        });
      r.inherits(u, s),
        function () {
