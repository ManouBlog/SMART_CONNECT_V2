...
<template>
  ...
  >
    <div class="row">
        <legend class="w-25 mx-5">Companie</legend>
      <div class="col-md-12">
        <div class="mb-3">
      ...
      <div class="col-md-12">
        <div class="mb-3">
          <label class="form-label">Registration number/cc</label>
          <input
            v-model="user.matricule_cc"
            class="form-control"
            type="text"
      ...
      <legend class="w-25 mx-5">Manager</legend>
      <div class="col-md-12">
        <div class="mb-3">
          <label class="form-label">Last name and first names</label>
          <input
            v-model="user.gerant"
            class="form-control"
            type="text"
