    ...
    return {
      rules: {
        payment_term: [
          {
            required: true,
            message: "Les termes sont obligatoires",
            trigger: "blur"
          }
        ],
              ...
              <a-col :xs="24" :md="12">
                <a-form-item name="categorie_offre_id" :label="texte1">
                  <a-select v-model:value="formState.categorie_offre_id" @change="selectCategorieFormState"
                    ...
                    :filter-option="filterOption" :disabled="!categoriesOffres.length" option-filter-prop="label"
            ...
            <a-row :gutter="[16, 16]">
              <a-col :span="24">
                <a-form-item name="description" :label="texte18">
                  <a-textarea v-model:value="this.formState.description" :rows="6"
