<template>
  <div class="page-body position-relative">
    <n-modal v-model:show="showModalDetailAbonnement" :closable="false" preset="card"
        ...
        ">Référence</th>
                  ...
                  <tbody style="border: 2px solid #dee2e6; border-top: none;">
                    <tr v-for="(item, index) in detailsAbonnement.add_profil_hybrides" :key="index"
                      ...
                      <td
                        style="padding: 10px;text-align: center; text-align: right; font-weight: 600; color: #198754;">
    ...
    <div class="tab-content" id="top-tabContent">
      <!-- ✅ Desktop -->
      <DataTable v-if="!isMobile" paginator :rows="10" :globalFilterFields="['abonement.libelle']"
        :rowsPerPageOptions="[5, 10, 20, 50]" :value="list_abonnement" v-model:filters="filters">
        <template #empty>
          ...
          <div class="conteneur_search" style="display: flex; align-items: center">
            ...
            <IconField iconPosition="left">
              ...
              <InputText style="width: 300px; font-size: 1.2em; border: 2px solid orange"
                v-model="filters['global'].value" :placeholder="texte9" />
            </IconField>
          </div>
        </template>

        <Column style="font-size: 1.3em; padding: 1em; text-align: center" field="created_at" :header="texte10">
        ...
        <Column style="font-size: 1.3em; padding: 1em; text-align: center" field="abonement.libelle" :header="texte4" />
        <!-- <Column
          style="font-size: 1.3em; padding: 1em; text-align: center"
          field="montant"
          :header="texte5"
        /> -->
        <Column style="font-size: 1.3em; padding: 1em; text-align: center" field="echeance" :header="texte6" />
        <Column style="font-size: 1.3em; padding: 1em; text-align: center" field="statut" :header="texte7">
          <template #body="slotProps">
        ...
        <Column style="font-size: 1.3em; padding: 1em; text-align: center" field="statut" :header="'Détail'">
          <template #body="slotProps">
        ...
        <div v-for="item in list_abonnement" :key="item.id" class="abonnement-card">
          ...
          <div class="card-body">
            ...
            <div style="display: flex;justify-content: flex-end;">
              <button @click="handleDetailAbonnement(item)" style="background-color: orange;">Détail <i
                  class="bi bi-eye" style="cursor: pointer;"></i></button>
            </div>
          </div>
        </div>
