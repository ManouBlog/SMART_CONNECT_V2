...
export default {
  ...
  methods: {
    ...
    update_offre() {
      axios
        .put(
          "http://192.168.1.2:8000/api/modify_offre_entreprise/" +
            this.id_offre_update,
          {
    ...
    get_offres() {
      this.spinner = true;
      axios
        .get("http://192.168.1.2:8000/api/get_offres_entreprise", {
          headers: {
            Authorization: "Bearer " + this.$store.state.token,
          },
        })
    ...
    create_offre() {
      ...
      axios
        .post(
          "http://192.168.1.2:8000/api/create_offre",
          {
    ...
    delete_offre() {
      axios
        .delete(
          "http://192.168.1.2:8000/api/delete_offre_entreprise/" +
            this.id_for_delete,
          {
            headers: {
              Authorization: "Bearer " + this.$store.state.token,
    ...
    get_categorie() {
      this.spinner = true;
      axios
        .get("http://192.168.1.2:8000/api/seeCategorie", {
          headers: {
            Authorization: "Bearer " + this.$store.state.token,
          },
        })
