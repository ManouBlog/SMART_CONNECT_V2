...
export default {
  ...
  methods: {
    ...
    update_offre() {
      axios
        .put(
          "http://backend.monbrobroli.com/api/modify_offre_entreprise/" +
            this.id_offre_update,
          {
    ...
    get_offres() {
      this.spinner = true;
      axios
        .get("http://backend.monbrobroli.com/api/get_offres_entreprise", {
          headers: {
            Authorization: "Bearer " + this.$store.state.token,
          },
        })
    ...
    create_offre() {
      ...
      axios
        .post(
          "http://backend.monbrobroli.com/api/create_offre",
          {
    ...
    delete_offre() {
      axios
        .delete(
          "http://backend.monbrobroli.com/api/delete_offre_entreprise/" +
            this.id_for_delete,
          {
            headers: {
              Authorization: "Bearer " + this.$store.state.token,
