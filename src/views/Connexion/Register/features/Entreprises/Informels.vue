...
<template>
  ...
  <transition name="fade-slide">
    <a-form v-if="formState.optionsAnswer" :layout="'vertical'" :model="formState" name="basic" autocomplete="on"
      ...
      <a-row :gutter="[16, 24]">
        <a-col :xs="24" :md="12">
          <a-form-item :label="'Nom de l\'Entreprise'" name="nom_particulier">
            <a-input v-model:value="formState.nom_particulier" placeholder="Entrez le nom de votre entreprise" />
          </a-form-item>
        </a-col>

        <a-col :xs="24" :md="12">
          <a-form-item :label="texte2" name="contact" :rules="[
            ...
            <a-input type="tel" v-model:value="formState.contact" placeholder="Entrez le numéro téléphonique">
      ...
      <a-row :gutter="[16, 24]">
        <a-col :xs="24" :md="24">
          <a-form-item :label="texte12" name="password"
            ...
            <a-input-password v-model:value="formState.password" placeholder="Ajoutez votre mot de passe" />
          </a-form-item>
        </a-col>
      </a-row>
      <!-- <div>
      ...
      <a-form-item>
        <div class="d-flex justify-content-center">
          <a-button :disabled="isPasswordDisabled || !this.formState.upload.length || isCommercialAssitance"
