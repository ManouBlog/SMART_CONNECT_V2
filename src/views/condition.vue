...
<template>
  <div>
    <div class="myconteneur">
      ...
      <section class="p-4 row" style="padding: 1.5em; font-family: 'Roboto', 'Segoe UI', Arial, sans-serif;color:black">
        <p>
        ...
        <p>
          ...
          accessibles sur le site <a href="https://monbrobroli.com/"
            style="color: blue; text-decoration: underline;">www.MonBrobroli.com</a>
...
PERSONNEL
        ...
        <p>
          ...
          <a href="mailto:contact@monbrobroli.com"
            style="text-decoration: underline; color: blue">contact@monbrobroli.com</a>
        </p>
