  ...
  <div>
    <div class="myconteneur">
      ...
      <p style="padding: 0 3.5em; font-family: 'Roboto', 'Segoe UI', Arial, sans-serif">
        ...
        Abidjan-Cocody les deux-plateaux, BP 995 Abidjan 27, Tél. : 05 46 66 77 66, est
        une société de droit ivoirien spécialisée dans le domaine des services et plus
        précisement en expertise informatique et télécoms, concepteur de la plateforme en
        ligne MonBroBroli. MonBrobroli est une plateforme gratuite en ligne qui a pour
        vocation principale de mettre en relation de manière transparente et équilibrée.
        ...
        tablettes ou d’ordinateurs. L’accès à certaines fonctionnalités de la plateforme
        est soumis à un abonnement annuel obligatoire, selon les conditions ci-après.
      ...
      >
        ...
        <p>
          ...
          informations fournies et sécuriser les échanges entre les différentes parties.
          En conséquence, toute création de compte par un (e) utilisateur (trice) emporte
          son adhésion, sans restriction ni réserve, aux présentes Conditions Générales
          ...
          société, quelque soit le moment où elle aura pu être portée à sa connaissance.
          Si LCE ne se prévaut pas ponctuellement de l’une quelconque des dispositions des
        ...
        <p>
          ...
          recherche d’un emploi à temps partiel et les entreprises ou particuliers en
          quête de profils qualifiés. Afin de garantir la qualité des services proposés et
          d'assurer le bon déroulement des missions, l’accès à certaines fonctionnalités
          de la plateforme est soumis à un abonnement annuel obligatoire, selon deux
          formules disponibles : <span style="font-weight: bold">ECO</span> et
        ...
        <p>
          ...
          l’identité de l’utilisateur (trice). L’Abonnement mensuel ou annuel est payable
          en ligne par une interface intégrant les paiements par mobilemoney, wave, visa
          ou tout autre moyen présent ou futur accepté par l’interface mise à disposition.
        </p>
        ...
        <p>
          -<span style="font-weight: bold">Formule ECO 10.000 Fcfa / an</span> Offre un
          accès complet aux offres d'emploi disponibles sur la plateforme.
        </p>
        <p>
          -<span style="font-weight: bold">Formule PLATINUM 20.000 Fcfa / an</span> Inclut
          tous les avantages de la formule ECO, avec en plus : La réception d'offres
          d’emploi ciblées par email et dans votre espace personalisé, selon les
        ...
        <p>
          -<span style="font-weight: bold">Formule ECO 25.000 Fcfa / an</span> Donne accès
          à la base de données des profils étudiants qualifiés. Possibilité de publier des
          offres de mission. Le premier recrutement est gratuit.
        </p>
        <p>
          -<span style="font-weight: bold">Formule PLATINUM 50.000 Fcfa / an </span>Accès
          à la base de profils. Publication illimitée d’offres. Positionnement prioritaire
          des annonces en tête de liste lors des recherches effectuées sur la plateforme.
          Le premier recrutement est gratuit
        </p>
        <p style="text-align: center">(2) Résiliation</p>
        <p>
          A défaut pour l’abonné(e) de résilier son contrat dans un délai minimum d’un
          mois avant la date d’expiration du contrat par lettre recommandée avec accusé de
          ...
          courir pour sa durée minimale. Il ne sera procédé à aucun remboursement. En cas
          de non-paiement par l’abonné(e) de son abonnement aux échéances convenues, LCE
          pourra procéder à la résiliation du contrat d’abonnement sans qu’aucune
          indemnité de quelque nature que ce soit ne soit mise à sa charge. En cas de non
          utilisation des prestations liées à l abonnement, aucun rembousement ne sera
          effectué.
        </p>
        <h2 class="text-left">
        ...
        <p>
          ...
          spécifiques (missions ponctuelles, projets ou services). Chaque annonce doit
          être claire, précise et conforme aux conditions d’utilisation de la plateforme.
        </p>
        ...
        <p>
          Les entreprises et les particuliers qui déposent des offres sur la plateforme
        ...
        <p>
          ...
          mesures disciplinaires prises par la plateforme MonBrobroli.En cas de
          non-respect avéré du règlement, la plateforme se réserve expressément le droit
          de :
        </p>
        <p>
        ...
        <p>
          ...
          compétentes lorsque la situation l’exige, conformément aux obligations légales
          en vigueur.
        </p>
        <p>
        ...
        <p>
          ...
          exonérée de toute responsabilité relative à l’exécution d’un contrat à la suite
          de l’utilisation de la plateforme par les abonnés. En tout état de cause, LCE ne
          saurait être tenue pour responsable de l’inexécution de ses obligations en cas
          de force majeure définie par le Code Civil, et notamment en cas de grève totale
          ou partielle, inondation, incendie, panne informatique, etc. (liste non
          exhaustive).
        </p>
        <h2 class="text-left">
        ...
        <p>
          *le respect rigoureux de la vie privée conformément aux dispositions légales et
          réglementaires applicables en matière de protection des données (loi n°2013-451
          du 19 juin 2013 relative à la protection des données à caractère personnel).
        </p>
        <p>
        ...
        <p>
          ...
          demander leur utilisation conformément à la legislation en vigueur, s’opposer à
          un traitement pour des motifs legitmes en formulant une demande à l’adresse :
          <a
        ...
        <p>
          - Données relatives à la formation : diplôme, niveau d’etude, carte d’étudiant
          en cours de validité, ect…
        </p>
        <p>
        ...
        <p>
          ...
          personnelles est nécessaire à l'utilisation de la plateforme et qu’il peut
          retirer son consentement à tout moment en adressant une demande à
