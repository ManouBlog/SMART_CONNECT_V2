               ...
               class="tab-pane fade in white-text">
                ...
                >
                  ...
                  >
                    ...
                    <div class="w-100 text-left" v-if="status == 'entreprise'">
                      <Span :name="'Régistre'" :isFacultatif="false" />
                      <input
                        type="file"
                        @change="selectFileForRegistre"
                        class="w-100 my-3"
                      />
                    </div>
                    <div
                    ...
                    <div class="w-100 text-left" v-if="status == 'entreprise'">
                      ...
                      <input type="text" class="w-100 my-3" v-model="gerant" />
                    </div>
                    <div class="w-100 text-left" v-if="status == 'entreprise'">
                    ...
                    <div class="w-100 text-left" v-if="status == 'entreprise'">
                      <Span
                        :name="'Pièce d\'identifiant du gérant'"
                        :isFacultatif="false"
                      />
                      <input
                        type="file"
                        @change="uploadFilePieceGerant"
                        class="w-100 my-3"
                      />
                    </div>
                    ...
                    <div class="w-100 text-left" v-if="status">
                      ...
                      <p class="m-0 fw-bold">
                        ...
                        <span class="d-block m-0 password_length"
                          >Une lettre majuscule
                          <i
                            v-if="password && /[A-Z]/.test(password)"
                            class="bi bi-check-lg"
                          ></i>
                        </span>
                        <span class="d-block m-0 password_length"
                        ...
                        <span class="d-block m-0 password_length"
                          >Un caractère spécial
                          <i
                            v-if="verifChiffre.test(password)"
                            class="bi bi-check-lg"
                          ></i>
                        </span>
                      </p>
                    ...
                    <div>
                      <button @click.prevent="authGoogle">Google</button>
                    </div>
                  </form>
                </div>
                <div
      ...
      <div class="row">
        <div class="container main-container-home">
          <div class="col-lg-offset-1 col-lg-11 col-md-12 col-sm-12 col-xs-12">
            <ul class="nav nav-pills registre_login_connex">
              <li class="active">
                <a data-toggle="tab" href="#login">Connection</a>
              </li>
              <li>
                <a data-toggle="tab" href="#register-account">Register</a>
              </li>
            </ul>
            ...
            <div class="tab-content">
              <div id="register-account" class="tab-pane fade in white-text">
                ...
                >
                  ...
                  >
                    <div class="w-100 my-2 text-left">
                      <Span :name="'Select a status'" :isFacultatif="false" />
                      <select v-model="status" class="select">
                        <option disabled value="">Select a status</option>
                        <option value="student">Student</option>
                        <option value="entreprise">Companies</option>
                    ...
                    <div
                      ...
                      v-if="status == 'student' || status == 'particulier'"
                    >
                      <Span :name="'last name'" :isFacultatif="false" />
                      <input type="text" class="w-100 my-3" v-model="nom" />
                    </div>
                    <div
                      class="w-100 text-left"
                      v-if="status == 'student' || status == 'particulier'"
                    >
                      <Span :name="'first name'" :isFacultatif="false" />
                      <input type="text" class="w-100 my-3" v-model="prenoms" />
                    </div>
                    <div class="w-100 text-left" v-if="status">
                      <Span :name="'Phone'" :isFacultatif="false" />
                      <input
                        class="w-100 my-3"
                        type="text"
                        v-model="phone"
                    ...
                    <div class="w-100 text-left" v-if="status">
                      <Span :name="'City'" :isFacultatif="false" />
                      <input type="text" class="w-100 my-3" v-model="ville" />
                    </div>
                    <div class="w-100 text-left" v-if="status">
                      <Span :name="'Municipality'" :isFacultatif="false" />
                      <input type="text" class="w-100 my-3" v-model="commune" />
                    </div>
                    <div class="w-100 text-left" v-if="status">
                    ...
                    <div class="w-100 text-left" v-if="status == 'student'">
                      <Span :name="'Diploma'" :isFacultatif="true" />
                      <input class="w-100 my-3" type="text" v-model="diplome" />
                    </div>
                    <div class="w-100 text-left" v-if="status == 'student'">
                    ...
                    <div class="w-100 text-left" v-if="status">
                      <Span :name="'Password'" :isFacultatif="false" />
                      <input
                        type="password"
                        name="password"
                        id="password"
              ...
              <div id="login" class="tab-pane fade active in white-text">
                ...
                >
                  ...
                  >
                    ...
                    <div class="text-left w-100">
                      <Span :name="'Password'" :isFacultatif="true" />
                      <input
                        type="password"
                        v-model="password"
                        name="password-2"
