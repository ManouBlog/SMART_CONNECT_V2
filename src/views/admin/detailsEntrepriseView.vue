...
<template>
  <div class="page-body position-relative">
        ...
        <div>
          ...
          <h4 v-if="entreprise?.piece_gerant" style="display:flex;align-items:center;gap:1em;">
            ...
            <n-image
              ...
              width="100"
              :src="'https://backend.smart-connect.online/storage/images/'+entreprise?.piece_gerant"
              />
          </h4>
          ...
          <h4 v-if="entreprise?.logo" style="display:flex;align-items:center;gap:1em;">
            ...
            <n-image
               :alt="entreprise?.logo"
              width="100"
              :src="'https://backend.smart-connect.online/storage/images/'+entreprise?.logo"
              />
          </h4>
    ...
    <n-card title="Document PDF" closable @close="showModal = false">
      <iframe
        :src="'https://backend.smart-connect.online/storage/pdf/'+entreprise?.registre"
