...
export default {
  ...
  methods: {
    ...
    create_categorie() {
      axios
        .post(
          "https://backend-test.monbrobroli.com/api/create_categorie-abonnement",
    ...
    create_abonnement() {
      axios
        .post("https://backend-test.monbrobroli.com/api/create-abonnement", this.data, {
          headers: {
            Authorization: "Bearer " + this.$store.state.token,
          },
        })
    ...
    get_categorie() {
      axios
        .get("https://backend-test.monbrobroli.com/api/getCategorie", {
          headers: {
            Authorization: "Bearer " + this.$store.state.token,
          },
        })
    ...
    get_abonnements(isLoading = null) {
      ...
      axios
        .get("https://backend-test.monbrobroli.com/api/getAbonnement", {
          headers: {
            Authorization: "Bearer " + this.$store.state.token,
          },
        })
    ...
    deleteAbonnement(idAbonnement) {
      ...
      axios
        .delete(
          "https://backend-test.monbrobroli.com/api/admin/deleteAbonnement/" + idAbonnement,
          {
            headers: {
              Authorization: "Bearer " + this.$store.state.token,
            },
    ...
    deleteCategorieAbonnement(idCategorie) {
      this.spinner = true;
      axios
        .delete("https://backend-test.monbrobroli.com/api/deleteCategorie/" + idCategorie, {
          headers: {
            Authorization: "Bearer " + this.$store.state.token,
          },
        })
