...
export default {
  ...
  methods: {
    ...
    create_categorie() {
      axios
        .post(
          "http://192.168.1.2:8000/api/create_categorie-abonnement",
    ...
    create_abonnement() {
      axios
        .post("http://192.168.1.2:8000/api/create-abonnement", this.data, {
          headers: {
            Authorization: "Bearer " + this.$store.state.token,
          },
        })
    ...
    get_abonnements(isLoading = null) {
      ...
      axios
        .get("http://192.168.1.2:8000/api/getAbonnement", {
          headers: {
            Authorization: "Bearer " + this.$store.state.token,
          },
        })
    ...
    deleteAbonnement(idAbonnement) {
      ...
      axios
        .delete(
          "http://192.168.1.2:8000/api/admin/deleteAbonnement/" + idAbonnement,
          {
            headers: {
              Authorization: "Bearer " + this.$store.state.token,
            },
    ...
    deleteCategorieAbonnement(idCategorie) {
      this.spinner = true;
      axios
        .delete("http://192.168.1.2:8000/api/deleteCategorie/" + idCategorie, {
          headers: {
            Authorization: "Bearer " + this.$store.state.token,
          },
        })
