...
export default {
  ...
  methods: {
    get_students_contact() {
      //this.spinner = false;
      axios
        .get("https://backend-test.monbrobroli.com/api/list_students_contact_by_entreprise", {
          headers: {
    ...
    get_all_timetables() {
      this.spinner = true;
      axios
        .get("https://backend-test.monbrobroli.com/api/list_emplois_temps")
        .then((res) => {
          console.log(res);
    ...
    sendAppreciation() {
      ...
      axios
        .post(
          "https://backend-test.monbrobroli.com/api/giveAvis",
          {
