...
export default {
  ...
  methods: {
    get_students_contact() {
      //this.spinner = false;
      axios
        .get("http://192.168.1.14:8000/api/list_students_contact_by_entreprise", {
          headers: {
    ...
    get_all_timetables() {
      this.spinner = true;
      axios
        .get("http://192.168.1.14:8000/api/list_emplois_temps")
        .then((res) => {
          console.log(res);
    ...
    sendAppreciation() {
      ...
      axios
        .post(
          "http://192.168.1.14:8000/api/giveAvis",
          {
