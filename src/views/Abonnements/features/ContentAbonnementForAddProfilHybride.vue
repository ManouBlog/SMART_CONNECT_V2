    ...
    <section>
      <p style="text-align:center;position: absolute;right: 0;">
        <span v-if="storeAbonnementUser?.planAbonnement?.abonement_id === item.id && currentConfig.isFormule"
          class="badge" style="background-color: white;color:black;">
          Active
        </span>
      </p>
      ...
      <div class="conteneur-btn">
        <Buttons :elmentsOfBtn="elmentsOfBtn" shapeBtn="round" @created="currentConfig.action" />
      </div>
    </section>
  </div>
  <div v-if="storeAbonnement.addProfilHybride.length &&
    ...
    <section>
      ...
      <div class="d-flex gap-5 align-items-center justify-content-center main-color">
        <div style="display: flex;flex-direction: column;">
          ...
          <h1 v-if="currentNotAbonnamentSuccessConfig.priceWithProfilHybride != currentNotAbonnamentSuccessConfig.price"
            style="font-size: 2em; font-weight: bold;padding: 0;margin: 0;">
      ...
      <div class="conteneur-btn">
        <Buttons :elmentsOfBtn='elmentsOfBtn' shapeBtn="round" @created="currentNotAbonnamentSuccessConfig.action" />
      </div>
    </section>
  </div>
