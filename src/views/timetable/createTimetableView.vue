  ...
  methods: {
    ...
    update_timetable() {
      ...
      if (
        ...
        axios
          .put(
            "http://192.168.1.14:8000/api/modify_schedule/" +
    ...
    get_timetable() {
      this.spinner = true;
      axios
        .get("http://192.168.1.14:8000/api/get_schedule", {
          headers: {
            Authorization: "Bearer " + this.$store.state.token,
          },
        })
    ...
    create_timetable() {
      ...
      if (
        ...
        axios
          .post(
            "http://192.168.1.14:8000/api/create_schedule",
            {
              jour: DateRendezVous,
    ...
    delete_timetable() {
      axios
        .delete(
          "http://192.168.1.14:8000/api/delete_schedule/" + this.id_for_delete,
          {
            headers: {
              Authorization: "Bearer " + this.$store.state.token,
            },
