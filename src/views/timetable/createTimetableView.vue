...
export default {
  ...
  methods: {
    ...
    get_timetable() {
      this.spinner = true;
      axios
        .get("https://backend.monbrobroli.com/api/get_schedule", {
          headers: {
            Authorization: "Bearer " + this.$store.state.token,
          },
        })
    ...
    create_timetable() {
      ...
      if (
        ...
        axios
          .post(
            "https://backend.monbrobroli.com/api/create_schedule",
            {
              jour: DateRendezVous,
    ...
    delete_timetable() {
      axios
        .delete(
          "https://backend.monbrobroli.com/api/delete_schedule/" + this.id_for_delete,
          {
            headers: {
              Authorization: "Bearer " + this.$store.state.token,
            },
