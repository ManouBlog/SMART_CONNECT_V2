...
<template>
  <section>
    ...
    <div v-if="!isLoading" class="container-fluid timetableSchedule" :class="isLoading ? 'conteneur_offre' : null">
      <div>
        <div class="container-fuid d-grid px-3" v-if="this.allFavoris.length">
          <div v-for="(emploi, index) in this.allFavoris" :key="index" class="card Mycard-body">
