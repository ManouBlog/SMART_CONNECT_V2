      ...
      <div class="container-fluid page-title bg-image position-relative">
        ...
        <form @submit.prevent="sendEmail">
          ...
          <div class="row container-fluid">
            <div class="col-lg-12">
              <label for="email" class="d-block">Entrez votre adresse email et nous vous enverrons <br> un lien de
                réinitialisation de mot de passe</label>
              <input class="w-100 p-4 " type="email" v-model="email" placeholder=" Entrez votre adresse email" required>
            </div>
          </div>
          <br>
          <div>
        ...
        <form @submit.prevent="sendEmail">
          ...
          <div class="row container-fluid">
            <div class="col-lg-12">
              ...
              <input class="w-100 p-4 " type="email" v-model="email" placeholder=" Enter your e-mail adress" required>
            </div>
          </div>
          <br>
          <div>
